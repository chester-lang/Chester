...
object aliases:
  ...
  object Keymap:
    ...
    extension (v: Keymap)
      inline def value: Ptr[KEYMAP_ENTRY] = v
  ...
  object rl_command_func_t:
    given _tag: Tag[rl_command_func_t] = Tag.materializeCFuncPtr2[CInt, CInt, CInt]
    inline def apply(inline o: CFuncPtr2[CInt, CInt, CInt]): rl_command_func_t = o
  ...
  object rl_compentry_func_t:
    given _tag: Tag[rl_compentry_func_t] = Tag.materializeCFuncPtr2[CString, CInt, CString]
    inline def apply(inline o: CFuncPtr2[CString, CInt, CString]): rl_compentry_func_t = o
  ...
  object rl_compignore_func_t:
    given _tag: Tag[rl_compignore_func_t] = Tag.materializeCFuncPtr1[Ptr[CString], CInt]
    inline def apply(inline o: CFuncPtr1[Ptr[CString], CInt]): rl_compignore_func_t = o
  ...
  object rl_completion_func_t:
    given _tag: Tag[rl_completion_func_t] = Tag.materializeCFuncPtr3[CString, CInt, CInt, Ptr[CString]]
    inline def apply(inline o: CFuncPtr3[CString, CInt, CInt, Ptr[CString]]): rl_completion_func_t = o
...
object structs:
  ...
  object FUNMAP:
    given _tag: Tag[FUNMAP] = Tag.materializeCStruct2Tag[CString, Ptr[rl_command_func_t]]
    def apply()(using Zone): Ptr[FUNMAP] = scala.scalanative.unsafe.alloc[FUNMAP](1)
    def apply(name : CString, function : Ptr[rl_command_func_t])(using Zone): Ptr[FUNMAP] =
      val ____ptr = apply()
      (!____ptr).name = name
   ...
   * [bindgen] header: readline.h
   */
  opaque type HISTORY_STATE = CStruct5[Ptr[Ptr[HIST_ENTRY]], CInt, CInt, CInt, CInt]
  object HISTORY_STATE:
    given _tag: Tag[HISTORY_STATE] = Tag.materializeCStruct5Tag[Ptr[Ptr[HIST_ENTRY]], CInt, CInt, CInt, CInt]
    def apply()(using Zone): Ptr[HISTORY_STATE] = scala.scalanative.unsafe.alloc[HISTORY_STATE](1)
    def apply(entries : Ptr[Ptr[HIST_ENTRY]], offset : CInt, length : CInt, size : CInt, flags : CInt)(using Zone): Ptr[HISTORY_STATE] =
      val ____ptr = apply()
  ...
  object HIST_ENTRY:
    given _tag: Tag[HIST_ENTRY] = Tag.materializeCStruct3Tag[CString, CString, histdata_t]
    def apply()(using Zone): Ptr[HIST_ENTRY] = scala.scalanative.unsafe.alloc[HIST_ENTRY](1)
    def apply(line : CString, timestamp : CString, data : histdata_t)(using Zone): Ptr[HIST_ENTRY] =
      val ____ptr = apply()
      (!____ptr).line = line
  ...
  object KEYMAP_ENTRY:
    given _tag: Tag[KEYMAP_ENTRY] = Tag.materializeCStruct2Tag[CChar, Ptr[rl_command_func_t]]
    def apply()(using Zone): Ptr[KEYMAP_ENTRY] = scala.scalanative.unsafe.alloc[KEYMAP_ENTRY](1)
    def apply(`type` : CChar, function : Ptr[rl_command_func_t])(using Zone): Ptr[KEYMAP_ENTRY] =
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).function = function
      ____ptr
  ...
  object UNDO_LIST:
    given _tag: Tag[UNDO_LIST] = Tag.materializeCStruct5Tag[Ptr[Byte], CInt, CInt, CString, undo_code]
    def apply()(using Zone): Ptr[UNDO_LIST] = scala.scalanative.unsafe.alloc[UNDO_LIST](1)
    def apply(next : Ptr[undo_list], start : CInt, end : CInt, text : CString, what : undo_code)(using Zone): Ptr[UNDO_LIST] =
      val ____ptr = apply()
      (!____ptr).next = next
      (!____ptr).start = start
      (!____ptr).end = end
  ...
  object _funmap:
    given _tag: Tag[_funmap] = Tag.materializeCStruct2Tag[CString, Ptr[rl_command_func_t]]
    def apply()(using Zone): Ptr[_funmap] = scala.scalanative.unsafe.alloc[_funmap](1)
    def apply(name : CString, function : Ptr[rl_command_func_t])(using Zone): Ptr[_funmap] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).function = function
      ____ptr
  ...
  object _hist_entry:
    given _tag: Tag[_hist_entry] = Tag.materializeCStruct3Tag[CString, CString, histdata_t]
    def apply()(using Zone): Ptr[_hist_entry] = scala.scalanative.unsafe.alloc[_hist_entry](1)
    def apply(line : CString, timestamp : CString, data : histdata_t)(using Zone): Ptr[_hist_entry] =
      val ____ptr = apply()
      (!____ptr).line = line
      (!____ptr).timestamp = timestamp
      (!____ptr).data = data
   ...
   * [bindgen] header: readline.h
   */
  opaque type _hist_state = CStruct5[Ptr[Ptr[HIST_ENTRY]], CInt, CInt, CInt, CInt]
  object _hist_state:
    given _tag: Tag[_hist_state] = Tag.materializeCStruct5Tag[Ptr[Ptr[HIST_ENTRY]], CInt, CInt, CInt, CInt]
    def apply()(using Zone): Ptr[_hist_state] = scala.scalanative.unsafe.alloc[_hist_state](1)
    def apply(entries : Ptr[Ptr[HIST_ENTRY]], offset : CInt, length : CInt, size : CInt, flags : CInt)(using Zone): Ptr[_hist_state] =
      val ____ptr = apply()
      (!____ptr).entries = entries
      (!____ptr).offset = offset
      (!____ptr).length = length
  ...
  object readline_state:
    given _tag: Tag[readline_state] = Tag.CArray[CChar, Nat.Digit3[Nat._2, Nat._2, Nat._4]](Tag.Byte, Tag.Digit3[Nat._2, Nat._2, Nat._4](Tag.Nat2, Tag.Nat2, Tag.Nat4))
    def apply()(using Zone): Ptr[readline_state] = scala.scalanative.unsafe.alloc[readline_state](1)
    ...
    extension (struct: readline_state)
      ...
      def point_=(value: CInt): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[CInt]] = value
      def end: CInt = !struct.at(offsets(1)).asInstanceOf[Ptr[CInt]]
      def end_=(value: CInt): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[CInt]] = value
      def mark: CInt = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]]
      def mark_=(value: CInt): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]] = value
      def buflen: CInt = !struct.at(offsets(3)).asInstanceOf[Ptr[CInt]]
      def buflen_=(value: CInt): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[CInt]] = value
      def buffer: CString = !struct.at(offsets(4)).asInstanceOf[Ptr[CString]]
      def buffer_=(value: CString): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[CString]] = value
      def ul: Ptr[UNDO_LIST] = !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[UNDO_LIST]]]
      def ul_=(value: Ptr[UNDO_LIST]): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[UNDO_LIST]]] = value
      def prompt: CString = !struct.at(offsets(6)).asInstanceOf[Ptr[CString]]
      def prompt_=(value: CString): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CString]] = value
      def rlstate: CInt = !struct.at(offsets(7)).asInstanceOf[Ptr[CInt]]
      def rlstate_=(value: CInt): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[CInt]] = value
      def done: CInt = !struct.at(offsets(8)).asInstanceOf[Ptr[CInt]]
      def done_=(value: CInt): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[CInt]] = value
      def kmap: Keymap = !struct.at(offsets(9)).asInstanceOf[Ptr[Keymap]]
      def kmap_=(value: Keymap): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[Keymap]] = value
      def lastfunc: Ptr[rl_command_func_t] = !struct.at(offsets(10)).asInstanceOf[Ptr[Ptr[rl_command_func_t]]]
      def lastfunc_=(value: Ptr[rl_command_func_t]): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[Ptr[rl_command_func_t]]] = value
      def insmode: CInt = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]]
      def insmode_=(value: CInt): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]] = value
      def edmode: CInt = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]]
      def edmode_=(value: CInt): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]] = value
      def kseq: CString = !struct.at(offsets(13)).asInstanceOf[Ptr[CString]]
      def kseq_=(value: CString): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CString]] = value
      def kseqlen: CInt = !struct.at(offsets(14)).asInstanceOf[Ptr[CInt]]
      def kseqlen_=(value: CInt): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[CInt]] = value
      def pendingin: CInt = !struct.at(offsets(15)).asInstanceOf[Ptr[CInt]]
      def pendingin_=(value: CInt): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[CInt]] = value
      def inf: Ptr[FILE] = !struct.at(offsets(16)).asInstanceOf[Ptr[Ptr[FILE]]]
      def inf_=(value: Ptr[FILE]): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[Ptr[FILE]]] = value
      def outf: Ptr[FILE] = !struct.at(offsets(17)).asInstanceOf[Ptr[Ptr[FILE]]]
      def outf_=(value: Ptr[FILE]): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[Ptr[FILE]]] = value
      def `macro`: CString = !struct.at(offsets(18)).asInstanceOf[Ptr[CString]]
      def macro_=(value: CString): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CString]] = value
      def catchsigs: CInt = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]]
      def catchsigs_=(value: CInt): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]] = value
      def catchsigwinch: CInt = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]]
      def catchsigwinch_=(value: CInt): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]] = value
      def entryfunc: Ptr[rl_compentry_func_t] = !struct.at(offsets(21)).asInstanceOf[Ptr[Ptr[rl_compentry_func_t]]]
      def entryfunc_=(value: Ptr[rl_compentry_func_t]): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[Ptr[rl_compentry_func_t]]] = value
      def menuentryfunc: Ptr[rl_compentry_func_t] = !struct.at(offsets(22)).asInstanceOf[Ptr[Ptr[rl_compentry_func_t]]]
      def menuentryfunc_=(value: Ptr[rl_compentry_func_t]): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[Ptr[rl_compentry_func_t]]] = value
      def ignorefunc: Ptr[rl_compignore_func_t] = !struct.at(offsets(23)).asInstanceOf[Ptr[Ptr[rl_compignore_func_t]]]
      def ignorefunc_=(value: Ptr[rl_compignore_func_t]): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[Ptr[rl_compignore_func_t]]] = value
      def attemptfunc: Ptr[rl_completion_func_t] = !struct.at(offsets(24)).asInstanceOf[Ptr[Ptr[rl_completion_func_t]]]
      def attemptfunc_=(value: Ptr[rl_completion_func_t]): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[Ptr[rl_completion_func_t]]] = value
      def wordbreakchars: CString = !struct.at(offsets(25)).asInstanceOf[Ptr[CString]]
      def wordbreakchars_=(value: CString): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[CString]] = value
      def reserved: CArray[CChar, Nat.Digit2[Nat._6, Nat._4]] = !struct.at(offsets(26)).asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._6, Nat._4]]]]
      def reserved_=(value: CArray[CChar, Nat.Digit2[Nat._6, Nat._4]]): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._6, Nat._4]]]] = value
    val offsets: Array[Int] =
      ...
      res(10) = align(res(9) + sizeof[Keymap].toInt, alignmentof[Ptr[rl_command_func_t]].toInt)
      res(11) = align(res(10) + sizeof[Ptr[rl_command_func_t]].toInt, alignmentof[CInt].toInt)
      ...
      res(21) = align(res(20) + sizeof[CInt].toInt, alignmentof[Ptr[rl_compentry_func_t]].toInt)
      res(22) = align(res(21) + sizeof[Ptr[rl_compentry_func_t]].toInt, alignmentof[Ptr[rl_compentry_func_t]].toInt)
      res(23) = align(res(22) + sizeof[Ptr[rl_compentry_func_t]].toInt, alignmentof[Ptr[rl_compignore_func_t]].toInt)
      res(24) = align(res(23) + sizeof[Ptr[rl_compignore_func_t]].toInt, alignmentof[Ptr[rl_completion_func_t]].toInt)
      res(25) = align(res(24) + sizeof[Ptr[rl_completion_func_t]].toInt, alignmentof[CString].toInt)
...
private[readline] object extern_functions:
   ...
   * [bindgen] header: readline.h
   */
  def replace_history_entry(_0 : CInt, _1 : CString, _2 : histdata_t): Ptr[HIST_ENTRY] = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_add_defun(_0 : CString, _1 : Ptr[rl_command_func_t], _2 : CInt): CInt = extern

  /**
   * [bindgen] header: readline.h
   */
  def rl_add_funmap_entry(_0 : CString, _1 : Ptr[rl_command_func_t]): CInt = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_bind_key_if_unbound(_0 : CInt, _1 : Ptr[rl_command_func_t]): CInt = extern

  /**
   * [bindgen] header: readline.h
   */
  def rl_bind_key_if_unbound_in_map(_0 : CInt, _1 : Ptr[rl_command_func_t], _2 : Keymap): CInt = extern

  /**
   * [bindgen] header: readline.h
   */
  def rl_bind_key_in_map(_0 : CInt, _1 : Ptr[rl_command_func_t], _2 : Keymap): CInt = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_bind_keyseq_if_unbound(_0 : CString, _1 : Ptr[rl_command_func_t]): CInt = extern

  /**
   * [bindgen] header: readline.h
   */
  def rl_bind_keyseq_if_unbound_in_map(_0 : CString, _1 : Ptr[rl_command_func_t], _2 : Keymap): CInt = extern

  /**
   * [bindgen] header: readline.h
   */
  def rl_bind_keyseq_in_map(_0 : CString, _1 : Ptr[rl_command_func_t], _2 : Keymap): CInt = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_callback_handler_install(_0 : CString, _1 : Ptr[rl_vcpfunc_t]): Unit = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_completion_matches(_0 : CString, _1 : Ptr[rl_compentry_func_t]): Ptr[CString] = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_function_of_keyseq(_0 : CString, _1 : Keymap, _2 : Ptr[CInt]): Ptr[rl_command_func_t] = extern

  /**
   * [bindgen] header: readline.h
   */
  def rl_function_of_keyseq_len(_0 : CString, _1 : size_t, _2 : Keymap, _3 : Ptr[CInt]): Ptr[rl_command_func_t] = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_generic_bind(_0 : CInt, _1 : CString, _2 : CString, _3 : Keymap): CInt = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_invoking_keyseqs_in_map(_0 : Ptr[rl_command_func_t], _1 : Keymap): Ptr[CString] = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_set_key(_0 : CString, _1 : Ptr[rl_command_func_t], _2 : Keymap): CInt = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_timeout_remaining(_0 : Ptr[CUnsignedInt], _1 : Ptr[CUnsignedInt]): CInt = extern

  /**
   * [bindgen] header: readline.h
   */
  def rl_translate_keyseq(_0 : CString, _1 : CString, _2 : Ptr[CInt]): CInt = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_trim_arg_from_keyseq(_0 : CString, _1 : size_t, _2 : Keymap): CInt = extern
   ...
   * [bindgen] header: readline.h
   */
  def rl_unbind_function_in_map(_0 : Ptr[rl_command_func_t], _1 : Keymap): CInt = extern
