...
object aliases:
   ...
   */
  type linenoiseCompletionCallback = CFuncPtr3[CString, Ptr[linenoiseCompletions], Ptr[Byte], Unit]
  object linenoiseCompletionCallback:
    given _tag: Tag[linenoiseCompletionCallback] = Tag.materializeCFuncPtr3[CString, Ptr[linenoiseCompletions], Ptr[Byte], Unit]
    inline def apply(inline o: CFuncPtr3[CString, Ptr[linenoiseCompletions], Ptr[Byte], Unit]): linenoiseCompletionCallback = o
    extension (v: linenoiseCompletionCallback)
      inline def value: CFuncPtr3[CString, Ptr[linenoiseCompletions], Ptr[Byte], Unit] = v
  ...
  object linenoiseFreeHintsCallback:
    given _tag: Tag[linenoiseFreeHintsCallback] = Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]): linenoiseFreeHintsCallback = o
   ...
   * [bindgen] header: linenoise.h
   */
  type linenoiseHintsCallback = CFuncPtr4[CString, Ptr[CInt], Ptr[CInt], Ptr[Byte], CString]
  object linenoiseHintsCallback:
    given _tag: Tag[linenoiseHintsCallback] = Tag.materializeCFuncPtr4[CString, Ptr[CInt], Ptr[CInt], Ptr[Byte], CString]
    inline def apply(inline o: CFuncPtr4[CString, Ptr[CInt], Ptr[CInt], Ptr[Byte], CString]): linenoiseHintsCallback = o
    extension (v: linenoiseHintsCallback)
      inline def value: CFuncPtr4[CString, Ptr[CInt], Ptr[CInt], Ptr[Byte], CString] = v
...
object structs:
  ...
  object linenoiseCompletions:
    given _tag: Tag[linenoiseCompletions] = Tag.materializeCStruct2Tag[size_t, Ptr[CString]]
    def apply()(using Zone): Ptr[linenoiseCompletions] = scala.scalanative.unsafe.alloc[linenoiseCompletions](1)
    def apply(len : size_t, cvec : Ptr[CString])(using Zone): Ptr[linenoiseCompletions] =
      val ____ptr = apply()
      (!____ptr).len = len
      (!____ptr).cvec = cvec
      ____ptr
...
private[linenoise] object extern_functions:
   ...
   * [bindgen] header: linenoise.h
   */
  def linenoiseAddCompletion(comp : Ptr[linenoiseCompletions], str : CString): Unit = extern
   ...
   * [bindgen] header: linenoise.h
   */
  def linenoiseSetCompletionCallback(comp : Ptr[linenoiseCompletionCallback], userdata : Ptr[Byte]): Ptr[linenoiseCompletionCallback] = extern

  /**
   * [bindgen] header: linenoise.h
   */
  def linenoiseSetFreeHintsCallback(callback : Ptr[linenoiseFreeHintsCallback]): Unit = extern

  /**
   * [bindgen] header: linenoise.h
   */
  def linenoiseSetHintsCallback(callback : Ptr[linenoiseHintsCallback], userdata : Ptr[Byte]): Unit = extern
