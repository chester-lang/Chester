...
object TerminalLoggerFactory extends UnderlyingLoggerFactory {
  ...
  object TerminalControlCode {
    val default: TerminalControlCode = c"\u001b[39m"
    val red: TerminalControlCode     = c"\u001b[31m"
    val green: TerminalControlCode   = c"\u001b[32m"
    val yellow: TerminalControlCode  = c"\u001b[33m"
    val blue: TerminalControlCode    = c"\u001b[34m"
    val magenta: TerminalControlCode = c"\u001b[35m"
    val cyan: TerminalControlCode    = c"\u001b[36m"
    val white: TerminalControlCode   = c"\u001b[37m"
  }
