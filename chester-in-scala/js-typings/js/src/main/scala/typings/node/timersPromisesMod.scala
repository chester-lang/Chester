...
import typings.node.anon.PickTimerOptionssignal
...
object timersPromisesMod {
  ...
  /**
    ...
    * @since v15.9.0
    */
  inline def setInterval[T](): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")().asInstanceOf[Any]
  inline def setInterval[T](delay: Double): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")(delay.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def setInterval[T](delay: Double, value: T): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def setInterval[T](delay: Double, value: T, options: TimerOptions): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def setInterval[T](delay: Double, value: Unit, options: TimerOptions): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def setInterval[T](delay: Unit, value: T): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def setInterval[T](delay: Unit, value: T, options: TimerOptions): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def setInterval[T](delay: Unit, value: Unit, options: TimerOptions): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setInterval")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  trait Scheduler_ extends StObject {
    ...
    def wait(delay: Double, options: PickTimerOptionssignal): js.Promise[Unit] = js.native
    def wait(delay: Unit, options: PickTimerOptionssignal): js.Promise[Unit] = js.native
