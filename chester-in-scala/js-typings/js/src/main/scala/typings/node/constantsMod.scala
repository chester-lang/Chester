...
object constantsMod {
  ...
  @JSImport("constants", "COPYFILE_EXCL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("constants", "COPYFILE_FICLONE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("constants", "COPYFILE_FICLONE_FORCE")
  @js.native
  ...
  @JSImport("constants", "ENGINE_METHOD_EC")
  @js.native
  ...
  @JSImport("constants", "ENGINE_METHOD_RSA")
  @js.native
  ...
  @JSImport("constants", "OPENSSL_VERSION_NUMBER")
  @js.native
  ...
  @JSImport("constants", "O_SYMLINK")
  @js.native
  val O_SYMLINK: Double = js.native
  
  /** Constant for fs.open(). Flag indicating that the file is opened for synchronous I/O. */
  @JSImport("constants", "O_SYNC")
  @js.native
  ...
  @JSImport("constants", "PRIORITY_ABOVE_NORMAL")
  @js.native
  val PRIORITY_ABOVE_NORMAL: Double = js.native
  
  @JSImport("constants", "PRIORITY_BELOW_NORMAL")
  @js.native
  val PRIORITY_BELOW_NORMAL: Double = js.native
  
  @JSImport("constants", "PRIORITY_HIGH")
  @js.native
  val PRIORITY_HIGH: Double = js.native
  
  @JSImport("constants", "PRIORITY_HIGHEST")
  @js.native
  val PRIORITY_HIGHEST: Double = js.native
  
  @JSImport("constants", "PRIORITY_LOW")
  @js.native
  val PRIORITY_LOW: Double = js.native
  
  @JSImport("constants", "PRIORITY_NORMAL")
  @js.native
  ...
  @JSImport("constants", "RSA_PSS_SALTLEN_AUTO")
  @js.native
  val RSA_PSS_SALTLEN_AUTO: Double = js.native
  
  /** Sets the salt length for RSA_PKCS1_PSS_PADDING to the digest size when signing or verifying. */
  @JSImport("constants", "RSA_PSS_SALTLEN_DIGEST")
  @js.native
  val RSA_PSS_SALTLEN_DIGEST: Double = js.native
  
  /** Sets the salt length for RSA_PKCS1_PSS_PADDING to the maximum permissible value when signing data. */
  @JSImport("constants", "RSA_PSS_SALTLEN_MAX_SIGN")
  @js.native
  ...
  @JSImport("constants", "SSL_OP_NO_TLSv1_3")
  @js.native
  ...
  @JSImport("constants", "SSL_OP_ALLOW_NO_DHE_KEX")
  @js.native
  ...
  @JSImport("constants", "SSL_OP_NO_ENCRYPT_THEN_MAC")
  @js.native
  ...
  @JSImport("constants", "SSL_OP_NO_RENEGOTIATION")
  @js.native
  ...
  @JSImport("constants", "SSL_OP_PRIORITIZE_CHACHA")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("constants", "UV_FS_O_FILEMAP")
  @js.native
  ...
  @JSImport("constants", "defaultCipherList")
  @js.native
  val defaultCipherList: String = js.native
  
  /** Specifies the built-in default cipher list used by Node.js (colon-separated values). */
  @JSImport("constants", "defaultCoreCipherList")
  @js.native
