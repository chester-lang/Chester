...
@js.native
trait TypeofpromisesCreateInterface extends StObject {
  ...
  /**
    ...
    * @since v17.0.0
    */
  var Interface: Instantiable0[typings.node.readlineMod.promises.Interface] = js.native
  ...
  var Readline: Instantiable2[
    ...
    typings.node.readlineMod.promises.Readline
  ] = js.native
