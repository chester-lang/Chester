...
object dnsPromisesMod {
  ...
  open class Resolver () extends StObject {
    ...
    @JSName("resolveCaa")
    var resolveCaa_Original: js.Function1[/* hostname */ String, js.Promise[js.Array[CaaRecord]]] = js.native
  ...
  @JSImport("dns/promises", "SERVFAIL")
  @js.native
  val SERVFAIL: ESERVFAIL = js.native
  
  @JSImport("dns/promises", "TIMEOUT")
  @js.native
