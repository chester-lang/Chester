...
object assertMod {
  ...
  /**
    ...
    */
  object strict extends Shortcut {
    ...
    type AssertPredicate = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AssertPredicate */ Any
    
    type AssertionError = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AssertionError */ Any
    
    type CallTrackerCall = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CallTrackerCall */ Any
    
    type CallTrackerReportInformation = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CallTrackerReportInformation */ Any
    ...
    /* This means you don't have to write `^`, but can instead just say `strict.foo` */
