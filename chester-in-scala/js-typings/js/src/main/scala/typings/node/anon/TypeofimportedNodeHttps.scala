...
@js.native
trait TypeofimportedNodeHttps extends StObject {
  
  /**
    * An `Agent` object for HTTPS similar to `http.Agent`. See {@link request} for more information.
    * @since v0.4.5
    */
  var Agent: Instantiable1[/* options */ js.UndefOr[AgentOptions], typings.node.nodeColonhttpsMod.Agent] = js.native
  ...
  var Server: Instantiable1[
    ...
    typings.node.nodeColonhttpsMod.Server[
      /* import warning: importer.ImportType#apply Failed type conversion: typeof http.IncomingMessage */ js.Any, 
      /* import warning: importer.ImportType#apply Failed type conversion: typeof http.ServerResponse */ js.Any
    ]
  ] = js.native
  ...
  /**
    ...
    */
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.ServerResponse */ js.Any */](): Server[Request, Response] = js.native
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.ServerResponse */ js.Any */](options: ServerOptions[Request, Response]): Server[Request, Response] = js.native
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.ServerResponse */ js.Any */](options: ServerOptions[Request, Response], requestListener: RequestListener[Request, Response]): Server[Request, Response] = js.native
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof http.ServerResponse */ js.Any */](requestListener: RequestListener[Request, Response]): Server[Request, Response] = js.native
