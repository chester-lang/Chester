...
/* Inlined node.fs.ObjectEncodingOptions & node.node:events.Abortable & {  mode :node.fs.Mode | undefined,   flag :string | undefined,   flush :boolean | undefined} */
...
object ObjectEncodingOptionsAborEncoding {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ObjectEncodingOptionsAborEncoding] (val x: Self) extends AnyVal {
