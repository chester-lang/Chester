...
import typings.node.nodeStrings.preview1
import typings.node.nodeStrings.unstable
...
object wasiMod {
  ...
  open class WASI () extends StObject {
    ...
    /**
      ...
      * @since v19.8.0
      */
    def getImportObject(): js.Object = js.native
    ...
    /**
      ...
      * @since v13.3.0, v12.16.0
      */
    def start(instance: js.Object): Double = js.native
  ...
  trait WASIOptions extends StObject {
    ...
    /**
      ...
      * @since v19.8.0
      */
    var version: unstable | preview1
  }
  object WASIOptions {
    
    inline def apply(version: unstable | preview1): WASIOptions = {
    ...
    implicit open class MutableBuilder[Self <: WASIOptions] (val x: Self) extends AnyVal {
      ...
      inline def setVersion(value: unstable | preview1): Self = StObject.set(x, "version", value.asInstanceOf[js.Any])
    }
  }
}
