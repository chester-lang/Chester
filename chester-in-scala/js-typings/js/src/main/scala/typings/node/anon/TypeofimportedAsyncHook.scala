...
trait TypeofimportedAsyncHook extends StObject {
  ...
  /**
    ...
    */
  var AsyncLocalStorage: Instantiable0[typings.node.asyncHooksMod.AsyncLocalStorage[js.Object]]
  ...
  var AsyncResource: Instantiable2[
    ...
    typings.node.asyncHooksMod.AsyncResource
  ]
...
object TypeofimportedAsyncHook {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedAsyncHook]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedAsyncHook] (val x: Self) extends AnyVal {
