...
inline def exec(command: String, options: (ObjectEncodingOptions & ExecOptions) | ExecOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("exec")(command.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
inline def exec(
  command: String,
...
inline def execFile(file: String, args: js.Array[String], options: ObjectEncodingOptions & ExecFileOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("execFile")(file.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
inline def execFile(
  file: String,
  args: js.Array[String],
...
inline def execFile(file: String, args: Null, options: ObjectEncodingOptions & ExecFileOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("execFile")(file.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
inline def execFile(
  file: String,
  args: Null,
  options: (ObjectEncodingOptions & ExecFileOptions) | ExecFileOptions,
...
inline def execFile(file: String, args: Unit, options: ObjectEncodingOptions & ExecFileOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("execFile")(file.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
inline def execFile(
  file: String,
  args: Unit,
  options: (ObjectEncodingOptions & ExecFileOptions) | ExecFileOptions,
...
inline def execFile(file: String, options: ObjectEncodingOptions & ExecFileOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("execFile")(file.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
// `options` without an `encoding` means stdout/stderr are definitely `string`.
inline def execFile(
  file: String,
  options: (ObjectEncodingOptions & ExecFileOptions) | ExecFileOptions,
...
inline def fork(modulePath: URL): ChildProcess = ^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any]).asInstanceOf[ChildProcess]
inline def fork(modulePath: URL, args: js.Array[String]): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
inline def fork(modulePath: URL, args: js.Array[String], options: ForkOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
inline def fork(modulePath: URL, args: Unit, options: ForkOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
inline def fork(modulePath: URL, options: ForkOptions): ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ChildProcess]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.node.nodeColondgramMod.Socket
  - scala.Unit
*/
type SendHandle = js.UndefOr[_SendHandle]
