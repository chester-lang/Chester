...
@js.native
trait TypeofreadPromisify extends StObject {
  ...
  def __promisify__(fd: Double): js.Promise[BufferArrayBufferView] = js.native
  ...
  def __promisify__(fd: Double, buffer: RelativeIndexable[js.BigInt], offset: Double, length: Double): js.Promise[BufferRelativeIndexable] = js.native
  def __promisify__(fd: Double, buffer: RelativeIndexable[js.BigInt], offset: Double, length: Double, position: Double): js.Promise[BufferRelativeIndexable] = js.native
  def __promisify__[TBuffer /* <: ArrayBufferView */](fd: Double, options: ReadAsyncOptions[TBuffer]): js.Promise[BufferTBuffer[TBuffer]] = js.native
}
