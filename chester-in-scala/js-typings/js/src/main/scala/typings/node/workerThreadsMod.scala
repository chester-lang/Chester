...
import typings.node.anon.FnCallTypeCallbackOptions
import typings.node.anon.FnCallTypeListenerOptions
import typings.node.anon.Message
import typings.node.globalsMod.global.NodeJS.Dict
import typings.node.globalsMod.global.NodeJS.RefCounted
...
object workerThreadsMod {
  ...
  open class MessagePort ()
    ...
    var addEventListener_Original: FnCallTypeListenerOptions = js.native
    ...
    var dispatchEvent_Original: js.Function1[/* event */ Event, Boolean] = js.native
    ...
    var removeEventListener_Original: FnCallTypeCallbackOptions = js.native
  ...
  */
  ...
  trait WorkerPerformance extends StObject {
    ...
    def eventLoopUtilization(utilization1: Unit, utilization2: EventLoopUtilization): EventLoopUtilization
    def eventLoopUtilization(utilization1: EventLoopUtilization): EventLoopUtilization
    def eventLoopUtilization(utilization1: EventLoopUtilization, utilization2: EventLoopUtilization): EventLoopUtilization
  ...
  object WorkerPerformance {
    ...
    inline def apply(
      eventLoopUtilization: (/* utilization1 */ js.UndefOr[EventLoopUtilization], /* utilization2 */ js.UndefOr[EventLoopUtilization]) => EventLoopUtilization
    ): WorkerPerformance = {
    ...
    implicit open class MutableBuilder[Self <: WorkerPerformance] (val x: Self) extends AnyVal {
      ...
      inline def setEventLoopUtilization(
        value: (/* utilization1 */ js.UndefOr[EventLoopUtilization], /* utilization2 */ js.UndefOr[EventLoopUtilization]) => EventLoopUtilization
