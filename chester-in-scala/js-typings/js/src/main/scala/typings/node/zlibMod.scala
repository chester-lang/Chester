...
object zlibMod {
  ...
  /**
    ...
    * @since v22.2.0
    */
  inline def crc32(data: String): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("crc32")(data.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def crc32(data: String, value: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("crc32")(data.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def crc32(data: Buffer): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("crc32")(data.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def crc32(data: Buffer, value: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("crc32")(data.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def crc32(data: ArrayBufferView): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("crc32")(data.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def crc32(data: ArrayBufferView, value: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("crc32")(data.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Double]
