...
/**
  ...
  * @param options `stream.transform` options
  */
inline def createHash(algorithm: String): Hash_ = ^.asInstanceOf[js.Dynamic].applyDynamic("createHash")(algorithm.asInstanceOf[js.Any]).asInstanceOf[Hash_]
inline def createHash(algorithm: String, options: HashOptions): Hash_ = (^.asInstanceOf[js.Dynamic].applyDynamic("createHash")(algorithm.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Hash_]
...
/**
  ...
  */
inline def createSecretKey(key: ArrayBufferView): KeyObject = ^.asInstanceOf[js.Dynamic].applyDynamic("createSecretKey")(key.asInstanceOf[js.Any]).asInstanceOf[KeyObject]
...
type LargeNumberLike = ArrayBufferView | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ Any) | js.typedarray.ArrayBuffer | js.BigInt
