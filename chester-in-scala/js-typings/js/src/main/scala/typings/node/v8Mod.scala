...
object v8Mod {
  ...
  inline def getHeapSnapshot(options: HeapSnapshotOptions): Readable = ^.asInstanceOf[js.Dynamic].applyDynamic("getHeapSnapshot")(options.asInstanceOf[js.Any]).asInstanceOf[Readable]
  ...
  /**
    ...
    * @experimental
    */
  inline def queryObjects(ctor: js.Function): Double | js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("queryObjects")(ctor.asInstanceOf[js.Any]).asInstanceOf[Double | js.Array[String]]
  inline def queryObjects(ctor: js.Function, options: `5`): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("queryObjects")(ctor.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def queryObjects(ctor: js.Function, options: `6`): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("queryObjects")(ctor.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  /**
    ...
    */
  inline def setHeapSnapshotNearHeapLimit(limit: Double): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setHeapSnapshotNearHeapLimit")(limit.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def writeHeapSnapshot(filename: String, options: HeapSnapshotOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("writeHeapSnapshot")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def writeHeapSnapshot(filename: Unit, options: HeapSnapshotOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("writeHeapSnapshot")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  */
  ...
  trait HeapSnapshotOptions extends StObject {
    ...
    /**
      ...
      * @default false
      */
    var exposeNumericValues: js.UndefOr[Boolean] = js.undefined
  }
  object HeapSnapshotOptions {
    
    inline def apply(): HeapSnapshotOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HeapSnapshotOptions]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: HeapSnapshotOptions] (val x: Self) extends AnyVal {
      ...
      inline def setExposeNumericValues(value: Boolean): Self = StObject.set(x, "exposeNumericValues", value.asInstanceOf[js.Any])
      
      inline def setExposeNumericValuesUndefined: Self = StObject.set(x, "exposeNumericValues", js.undefined)
    }
  }
  ...
  type StartupSnapshotCallbackFn = js.Function1[/* args */ Any, Any]
  
  @js.native
  trait StartupSnapshot_ extends StObject {
    ...
    /**
      ...
      * @since v18.6.0, v16.17.0
      */
    def addDeserializeCallback(callback: StartupSnapshotCallbackFn): Unit = js.native
    def addDeserializeCallback(callback: StartupSnapshotCallbackFn, data: Any): Unit = js.native
    ...
    /**
      ...
      * @since v18.6.0, v16.17.0
      */
    def addSerializeCallback(callback: StartupSnapshotCallbackFn): Unit = js.native
    def addSerializeCallback(callback: StartupSnapshotCallbackFn, data: Any): Unit = js.native
    
    /**
      * Returns true if the Node.js instance is run to build a snapshot.
      * @since v18.6.0, v16.17.0
      */
    def isBuildingSnapshot(): Boolean = js.native
    ...
    /**
      ...
      * @since v18.6.0, v16.17.0
      */
    def setDeserializeMainFunction(callback: StartupSnapshotCallbackFn): Unit = js.native
    def setDeserializeMainFunction(callback: StartupSnapshotCallbackFn, data: Any): Unit = js.native
  }
}
