...
@js.native
trait TypeofimportedUtil extends StObject {
  
  var MIMEParams: Instantiable0[typings.node.utilMod.MIMEParams] = js.native
  
  var MIMEType: Instantiable1[/* input */ String | ToString, typings.node.utilMod.MIMEType] = js.native
  
  var TextDecoder: Instantiable2[
    /* encoding */ js.UndefOr[String], 
    /* options */ js.UndefOr[Fatal], 
    typings.node.utilMod.TextDecoder
  ] = js.native
  
  var TextEncoder: Instantiable0[typings.node.utilMod.TextEncoder] = js.native
  ...
  val inspect: Typeofinspect = js.native
  def inspect(`object`: Any): String = js.native
  def inspect(`object`: Any, options: InspectOptions): String = js.native
  ...
  val promisify: Typeofpromisify = js.native
  def promisify(fn: js.Function): js.Function = js.native
  def promisify(fn: js.Function1[/* callback */ js.Function1[/* err */ js.UndefOr[Any], Unit], Unit]): js.Function0[js.Promise[Unit]] = js.native
  def promisify[T1](
  ...
  @JSName("promisify")
  def promisify_TResult[TResult](fn: js.Function1[/* callback */ js.Function2[/* err */ Any, /* result */ TResult, Unit], Unit]): js.Function0[js.Promise[TResult]] = js.native
