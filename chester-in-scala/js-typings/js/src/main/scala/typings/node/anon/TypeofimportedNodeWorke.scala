...
import typings.node.nodeColonworkerThreadsMod.BroadcastChannel
import typings.node.nodeColonworkerThreadsMod.MessageChannel
...
trait TypeofimportedNodeWorke extends StObject {
  ...
  /**
    ...
    * @since v15.4.0
    */
  var BroadcastChannel: Instantiable1[/* name */ String, typings.node.nodeColonworkerThreadsMod.BroadcastChannel]
  ...
  /**
    ...
    * @since v10.5.0
    */
  var MessageChannel: Instantiable0[typings.node.nodeColonworkerThreadsMod.MessageChannel]
  ...
  /**
    ...
    * @since v10.5.0
    */
  var MessagePort: Instantiable0[typings.node.nodeColonworkerThreadsMod.MessagePort]
  ...
  var Worker: Instantiable2[
    ...
    typings.node.nodeColonworkerThreadsMod.Worker
  ]
...
object TypeofimportedNodeWorke {
  
  inline def apply(
    BroadcastChannel: Instantiable1[/* name */ String, BroadcastChannel],
    MessageChannel: Instantiable0[MessageChannel],
    MessagePort: Instantiable0[typings.node.nodeColonworkerThreadsMod.MessagePort],
    SHARE_ENV: js.Symbol,
    ...
    __obj.asInstanceOf[TypeofimportedNodeWorke]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedNodeWorke] (val x: Self) extends AnyVal {
    ...
    inline def setMessagePort(value: Instantiable0[typings.node.nodeColonworkerThreadsMod.MessagePort]): Self = StObject.set(x, "MessagePort", value.asInstanceOf[js.Any])
