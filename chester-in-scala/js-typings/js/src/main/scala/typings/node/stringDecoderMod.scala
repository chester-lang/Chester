...
object stringDecoderMod {
  ...
  open class StringDecoder () extends StObject {
    ...
    def end(buffer: String): String = js.native
    def end(buffer: Buffer): String = js.native
    def end(buffer: ArrayBufferView): String = js.native
    ...
    /**
      ...
      * @param buffer The bytes to decode.
      */
    def write(buffer: String): String = js.native
    def write(buffer: Buffer): String = js.native
    def write(buffer: ArrayBufferView): String = js.native
  }
}
