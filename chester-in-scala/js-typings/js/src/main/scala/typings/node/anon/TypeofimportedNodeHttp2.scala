...
@js.native
trait TypeofimportedNodeHttp2 extends StObject {
  ...
  var Http2ServerRequest: Instantiable4[
    ...
    typings.node.nodeColonhttp2Mod.Http2ServerRequest
  ] = js.native
  
  var Http2ServerResponse: Instantiable1[/* stream */ ServerHttp2Stream, typings.node.nodeColonhttp2Mod.Http2ServerResponse] = js.native
