...
object osMod {
  ...
  object constants {
    ...
    object dlopen {
      ...
      @JSImport("os", "constants.dlopen.RTLD_DEEPBIND")
      @js.native
      val RTLD_DEEPBIND: Double = js.native
      
      @JSImport("os", "constants.dlopen.RTLD_GLOBAL")
      @js.native
      val RTLD_GLOBAL: Double = js.native
      
      @JSImport("os", "constants.dlopen.RTLD_LAZY")
      @js.native
      val RTLD_LAZY: Double = js.native
      
      @JSImport("os", "constants.dlopen.RTLD_LOCAL")
      @js.native
      val RTLD_LOCAL: Double = js.native
      
      @JSImport("os", "constants.dlopen.RTLD_NOW")
      @js.native
  ...
  */
  ...
  object UserInfo_ {
    ...
    inline def apply[T](gid: Double, homedir: T, uid: Double, username: T): UserInfo_[T] = {
      val __obj = js.Dynamic.literal(gid = gid.asInstanceOf[js.Any], homedir = homedir.asInstanceOf[js.Any], uid = uid.asInstanceOf[js.Any], username = username.asInstanceOf[js.Any], shell = null)
