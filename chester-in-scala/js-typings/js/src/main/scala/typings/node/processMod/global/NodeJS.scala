...
import typings.node.anon.KeepOpen
import typings.node.anon.Ref
...
import typings.node.anon.`7`
import typings.node.anon.`8`
...
import typings.node.nodeStrings.assert
import typings.node.nodeStrings.assertSlashstrict
import typings.node.nodeStrings.async_hooks
import typings.node.nodeStrings.beforeExit
import typings.node.nodeStrings.buffer_
import typings.node.nodeStrings.child_process
import typings.node.nodeStrings.cluster
import typings.node.nodeStrings.console
import typings.node.nodeStrings.constants
import typings.node.nodeStrings.crypto
import typings.node.nodeStrings.deepEqual
import typings.node.nodeStrings.deepStrictEqual
import typings.node.nodeStrings.dgram
import typings.node.nodeStrings.diagnostics_channel
import typings.node.nodeStrings.disconnect
import typings.node.nodeStrings.dns
import typings.node.nodeStrings.dnsSlashpromises
import typings.node.nodeStrings.domain
import typings.node.nodeStrings.equal
import typings.node.nodeStrings.events
import typings.node.nodeStrings.exit
import typings.node.nodeStrings.fs
import typings.node.nodeStrings.fsSlashpromises
import typings.node.nodeStrings.http
import typings.node.nodeStrings.http2
import typings.node.nodeStrings.https
import typings.node.nodeStrings.ifError
import typings.node.nodeStrings.inspector
import typings.node.nodeStrings.message
import typings.node.nodeStrings.module
import typings.node.nodeStrings.multipleResolves
import typings.node.nodeStrings.net
import typings.node.nodeStrings.nodeColonassert
import typings.node.nodeStrings.nodeColonassertSlashstrict
import typings.node.nodeStrings.nodeColonasync_hooks
import typings.node.nodeStrings.nodeColonbuffer
import typings.node.nodeStrings.nodeColonchild_process
import typings.node.nodeStrings.nodeColoncluster
import typings.node.nodeStrings.nodeColonconsole
import typings.node.nodeStrings.nodeColonconstants
import typings.node.nodeStrings.nodeColoncrypto
import typings.node.nodeStrings.nodeColondgram
import typings.node.nodeStrings.nodeColondiagnostics_channel
import typings.node.nodeStrings.nodeColondns
import typings.node.nodeStrings.nodeColondnsSlashpromises
import typings.node.nodeStrings.nodeColondomain
import typings.node.nodeStrings.nodeColonevents
import typings.node.nodeStrings.nodeColonfs
import typings.node.nodeStrings.nodeColonfsSlashpromises
import typings.node.nodeStrings.nodeColonhttp
import typings.node.nodeStrings.nodeColonhttp2
import typings.node.nodeStrings.nodeColonhttps
import typings.node.nodeStrings.nodeColoninspector
import typings.node.nodeStrings.nodeColonmodule
import typings.node.nodeStrings.nodeColonnet
import typings.node.nodeStrings.nodeColonos
import typings.node.nodeStrings.nodeColonpath
import typings.node.nodeStrings.nodeColonpathSlashposix
import typings.node.nodeStrings.nodeColonpathSlashwin32
import typings.node.nodeStrings.nodeColonperf_hooks
import typings.node.nodeStrings.nodeColonprocess
import typings.node.nodeStrings.nodeColonpunycode
import typings.node.nodeStrings.nodeColonquerystring
import typings.node.nodeStrings.nodeColonreadline
import typings.node.nodeStrings.nodeColonreadlineSlashpromises
import typings.node.nodeStrings.nodeColonrepl
import typings.node.nodeStrings.nodeColonsea
import typings.node.nodeStrings.nodeColonstream
import typings.node.nodeStrings.nodeColonstreamSlashconsumers
import typings.node.nodeStrings.nodeColonstreamSlashpromises
import typings.node.nodeStrings.nodeColonstreamSlashweb
import typings.node.nodeStrings.nodeColonstring_decoder
import typings.node.nodeStrings.nodeColonsys
import typings.node.nodeStrings.nodeColontest
import typings.node.nodeStrings.nodeColontestSlashreporters
import typings.node.nodeStrings.nodeColontimers
import typings.node.nodeStrings.nodeColontimersSlashpromises
import typings.node.nodeStrings.nodeColontls
import typings.node.nodeStrings.nodeColontrace_events
import typings.node.nodeStrings.nodeColontty
import typings.node.nodeStrings.nodeColonurl
import typings.node.nodeStrings.nodeColonutil
import typings.node.nodeStrings.nodeColonutilSlashtypes
import typings.node.nodeStrings.nodeColonv8
import typings.node.nodeStrings.nodeColonvm
import typings.node.nodeStrings.nodeColonwasi
import typings.node.nodeStrings.nodeColonworker_threads
import typings.node.nodeStrings.nodeColonzlib
...
import typings.node.nodeStrings.path
import typings.node.nodeStrings.pathSlashposix
import typings.node.nodeStrings.pathSlashwin32
import typings.node.nodeStrings.perf_hooks
import typings.node.nodeStrings.punycode
import typings.node.nodeStrings.querystring
import typings.node.nodeStrings.readline
import typings.node.nodeStrings.readlineSlashpromises
import typings.node.nodeStrings.rejectionHandled
import typings.node.nodeStrings.repl
import typings.node.nodeStrings.stream
import typings.node.nodeStrings.streamSlashconsumers
import typings.node.nodeStrings.streamSlashpromises
import typings.node.nodeStrings.streamSlashweb
import typings.node.nodeStrings.strict
import typings.node.nodeStrings.strictEqual
import typings.node.nodeStrings.string_decoder
import typings.node.nodeStrings.sys
import typings.node.nodeStrings.timers
import typings.node.nodeStrings.timersSlashpromises
import typings.node.nodeStrings.tls
import typings.node.nodeStrings.trace_events
import typings.node.nodeStrings.tty
...
import typings.node.nodeStrings.url
import typings.node.nodeStrings.util
import typings.node.nodeStrings.utilSlashtypes
import typings.node.nodeStrings.v8
import typings.node.nodeStrings.vm
import typings.node.nodeStrings.warning
import typings.node.nodeStrings.wasi
import typings.node.nodeStrings.worker
import typings.node.nodeStrings.worker_threads
import typings.node.nodeStrings.zlib
...
object NodeJS {
  ...
  */
  ...
  object Architecture {
    ...
    inline def loong64: typings.node.nodeStrings.loong64 = "loong64".asInstanceOf[typings.node.nodeStrings.loong64]
    ...
    inline def riscv64: typings.node.nodeStrings.riscv64 = "riscv64".asInstanceOf[typings.node.nodeStrings.riscv64]
  ...
  */
  ...
  trait Process
    ...
    /**
      ...
      * @since v20.13.0
      */
    def availableMemory(): Double = js.native
    ...
    /**
      ...
      * @since v7.1.0
      */
    var channel: js.UndefOr[Ref] = js.native
    ...
    /**
      ...
      * @experimental
      */
    def constrainedMemory(): Double = js.native
    ...
    /**
      ...
      * ```
      */
    def dlopen(module: js.Object, filename: String): Unit = js.native
    def dlopen(module: js.Object, filename: String, flags: Double): Unit = js.native
    ...
    def exit(code: String): scala.Nothing = js.native
    ...
    /**
      ...
      * @since v0.11.8
      */
    var exitCode: js.UndefOr[Double | String] = js.native
    ...
    /**
      ...
      */
    def getActiveResourcesInfo(): js.Array[String] = js.native
    
    def getBuiltinModule(id: String): js.UndefOr[js.Object] = js.native
    /**
    ...
    def getBuiltinModule_assert(id: assert): js.Function2[
        /* value */ Any, 
        /* message */ js.UndefOr[String | js.Error], 
        /* asserts value */ Boolean
      ] = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_assertstrict(id: assertSlashstrict): (Omit[
    ...
    @JSName("getBuiltinModule")
    def getBuiltinModule_asynchooks(id: async_hooks): TypeofimportedAsyncHook = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_buffer(id: buffer_): TypeofimportedBuffer = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_childprocess(id: child_process): TypeofimportedChildProc = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_cluster(id: cluster): TypeofimportedCluster = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_console(id: console): Any = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_constants(id: constants): (/* import warning: importer.ImportType#apply Failed type conversion: typeof osConstants.errno */ js.Any) & SignalConstants = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_crypto(id: crypto): TypeofimportedCrypto = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_dgram(id: dgram): TypeofimportedDgram = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_diagnosticschannel(id: diagnostics_channel): TypeofimportedDiagnostic = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_dns(id: dns): TypeofimportedDns = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_dnspromises(id: dnsSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_domain(id: domain): TypeofimportedDomain = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_events(id: events): (Instantiable1[
        /* options */ js.UndefOr[EventEmitterOptions], 
        ^[EventMap[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]]
      ]) & TypeofimportedEvents = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_fs(id: fs): TypeofimportedFs = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_fspromises(id: fsSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_http(id: http): TypeofimportedHttp = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_http2(id: http2): TypeofimportedHttp2 = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_https(id: https): TypeofimportedHttps = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_inspector(id: inspector): TypeofimportedInspector = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_module(id: module): Any = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_net(id: net): TypeofimportedNet = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeassert(id: nodeColonassert): js.Function2[
        /* value */ Any, 
        /* message */ js.UndefOr[String | js.Error], 
        /* asserts value */ Boolean
      ] = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeassertstrict(id: nodeColonassertSlashstrict): (Omit[
        /* import warning: importer.ImportType#apply Failed type conversion: typeof assert */ js.Any, 
        equal | notEqual | deepEqual | notDeepEqual | ok | strictEqual | deepStrictEqual | ifError | strict
      ]) & Call = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeasynchooks(id: nodeColonasync_hooks): TypeofimportedNodeAsync = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodebuffer(id: nodeColonbuffer): TypeofimportedNodeBuffe = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodechildprocess(id: nodeColonchild_process): TypeofimportedNodeChild = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodecluster(id: nodeColoncluster): TypeofimportedNodeClust = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeconsole(id: nodeColonconsole): Any = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeconstants(id: nodeColonconstants): (/* import warning: importer.ImportType#apply Failed type conversion: typeof osConstants.errno */ js.Any) & SignalConstants = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodecrypto(id: nodeColoncrypto): TypeofimportedNodeCrypt = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodedgram(id: nodeColondgram): TypeofimportedNodeDgram = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodediagnosticschannel(id: nodeColondiagnostics_channel): TypeofimportedNodeDiagn = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodedns(id: nodeColondns): TypeofimportedNodeDns = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodednspromises(id: nodeColondnsSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodedomain(id: nodeColondomain): TypeofimportedNodeDomai = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeevents(id: nodeColonevents): Any = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodefs(id: nodeColonfs): TypeofimportedNodeFs = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodefspromises(id: nodeColonfsSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodehttp(id: nodeColonhttp): TypeofimportedNodeHttp = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodehttp2(id: nodeColonhttp2): TypeofimportedNodeHttp2 = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodehttps(id: nodeColonhttps): TypeofimportedNodeHttps = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeinspector(id: nodeColoninspector): TypeofimportedNodeInspe = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodemodule(id: nodeColonmodule): Any = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodenet(id: nodeColonnet): TypeofimportedNodeNet = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeos(id: nodeColonos): TypeofimportedNodeOs = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodepath(id: nodeColonpath): PlatformPath = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodepathposix(id: nodeColonpathSlashposix): PlatformPath = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodepathwin32(id: nodeColonpathSlashwin32): PlatformPath = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeperfhooks(id: nodeColonperf_hooks): TypeofimportedNodePerf = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeprocess(id: nodeColonprocess): Process = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodepunycode(id: nodeColonpunycode): TypeofimportedNodePunyc = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodequerystring(id: nodeColonquerystring): TypeofimportedNodeQuery = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodereadline(id: nodeColonreadline): TypeofimportedNodeReadl = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodereadlinepromises(id: nodeColonreadlineSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_noderepl(id: nodeColonrepl): TypeofimportedNodeRepl = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodesea(id: nodeColonsea): TypeofimportedNodeSea = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodestream(id: nodeColonstream): Instantiable0[typings.node.nodeColonstreamMod.^] & TypeofimportedNodeStrea = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodestreamconsumers(id: nodeColonstreamSlashconsumers): ArrayBuffer = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodestreampromises(id: nodeColonstreamSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodestreamweb(id: nodeColonstreamSlashweb): ByteLengthQueuingStrategy = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodestringdecoder(id: nodeColonstring_decoder): TypeofimportedNodeStrin = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodesys(id: nodeColonsys): TypeofimportedNodeUtil = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodetest(id: nodeColontest): TypeofimportedNodeTest = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodetestreporters(id: nodeColontestSlashreporters): TypeofimportedReporters = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodetimers(id: nodeColontimers): TypeofimportedNodeTimer = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodetimerspromises(id: nodeColontimersSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodetls(id: nodeColontls): TypeofimportedNodeTls = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodetraceevents(id: nodeColontrace_events): TypeofimportedNodeTrace = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodetty(id: nodeColontty): TypeofimportedNodeTty = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeurl(id: nodeColonurl): TypeofimportedNodeUrl = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeutil(id: nodeColonutil): TypeofimportedNodeUtil = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeutiltypes(id: nodeColonutilSlashtypes): IsAnyArrayBuffer = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodev8(id: nodeColonv8): TypeofimportedNodeV8 = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodevm(id: nodeColonvm): TypeofimportedNodeVm = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodewasi(id: nodeColonwasi): TypeofimportedNodeWasi = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodeworkerthreads(id: nodeColonworker_threads): TypeofimportedNodeWorke = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_nodezlib(id: nodeColonzlib): TypeofimportedNodeZlib = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_os(id: os): TypeofimportedOs = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_path(id: path): PlatformPath = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_pathposix(id: pathSlashposix): PlatformPath = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_pathwin32(id: pathSlashwin32): PlatformPath = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_perfhooks(id: perf_hooks): TypeofimportedPerfHooks = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_process(id: typings.node.nodeStrings.process): Process = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_punycode(id: punycode): TypeofimportedPunycode = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_querystring(id: querystring): TypeofimportedQuerystrin = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_readline(id: readline): TypeofimportedReadline = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_readlinepromises(id: readlineSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_repl(id: repl): TypeofimportedRepl = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_stream(id: stream): Instantiable0[typings.node.streamMod.^] & TypeofimportedStream = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_streamconsumers(id: streamSlashconsumers): ArrayBuffer = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_streampromises(id: streamSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_streamweb(id: streamSlashweb): ByteLengthQueuingStrategy = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_stringdecoder(id: string_decoder): TypeofimportedStringDec = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_sys(id: sys): TypeofimportedUtil = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_timers(id: timers): TypeofimportedTimers = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_timerspromises(id: timersSlashpromises): ADDRGETNETWORKPARAMS = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_tls(id: tls): TypeofimportedTls = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_traceevents(id: trace_events): TypeofimportedTraceEven = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_tty(id: tty): TypeofimportedTty = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_url(id: url): TypeofimportedUrl = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_util(id: util): TypeofimportedUtil = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_utiltypes(id: utilSlashtypes): IsAnyArrayBuffer = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_v8(id: v8): TypeofimportedV8 = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_vm(id: vm): TypeofimportedVm = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_wasi(id: wasi): TypeofimportedWasi = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_workerthreads(id: worker_threads): TypeofimportedWorkerThr = js.native
    @JSName("getBuiltinModule")
    def getBuiltinModule_zlib(id: zlib): TypeofimportedZlib = js.native
    ...
    /**
      ...
      */
    def loadEnvFile(): Unit = js.native
    def loadEnvFile(path: String): Unit = js.native
    def loadEnvFile(path: URL): Unit = js.native
    def loadEnvFile(path: Buffer): Unit = js.native
    ...
    /**
      ...
      * @since v20.0.0
      */
    var permission: ProcessPermission = js.native
    ...
    /**
      ...
      * @experimental
      */
    def setSourceMapsEnabled(value: Boolean): Unit = js.native
    ...
    /**
      ...
      * @experimental
      */
    val sourceMapsEnabled: Boolean = js.native
    ...
    /**
      ...
      */
    var stderr: WriteStream & `7` = js.native
    ...
    /**
      ...
      */
    var stdin: ReadStream & `8` = js.native
  ...
  @js.native
  trait ProcessPermission extends StObject {
    ...
    /**
      ...
      * @since v20.0.0
      */
    def has(scope: String): Boolean = js.native
    def has(scope: String, reference: String): Boolean = js.native
  }
