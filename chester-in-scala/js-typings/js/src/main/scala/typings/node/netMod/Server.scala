...
open class Server () extends StObject {
  ...
  @JSName("addListener")
  def addListener_listening(event: typings.node.nodeStrings.listening, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("emit")
  def emit_listening(event: typings.node.nodeStrings.listening): Boolean = js.native
  ...
  @JSName("on")
  def on_listening(event: typings.node.nodeStrings.listening, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("once")
  def once_listening(event: typings.node.nodeStrings.listening, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("prependListener")
  def prependListener_listening(event: typings.node.nodeStrings.listening, listener: js.Function0[Unit]): this.type = js.native
  ...
  @JSName("prependOnceListener")
  def prependOnceListener_listening(event: typings.node.nodeStrings.listening, listener: js.Function0[Unit]): this.type = js.native
