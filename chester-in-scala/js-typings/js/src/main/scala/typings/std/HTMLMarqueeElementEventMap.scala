...
trait HTMLMarqueeElementEventMap
  ...
  /* standard dom */
  var bounce: org.scalajs.dom.Event
  
  /* standard dom */
  var finish: org.scalajs.dom.Event
...
object HTMLMarqueeElementEventMap {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HTMLMarqueeElementEventMap] (val x: Self) extends AnyVal {
    
    inline def setBounce(value: org.scalajs.dom.Event): Self = StObject.set(x, "bounce", value.asInstanceOf[js.Any])
    
    inline def setFinish(value: org.scalajs.dom.Event): Self = StObject.set(x, "finish", value.asInstanceOf[js.Any])
