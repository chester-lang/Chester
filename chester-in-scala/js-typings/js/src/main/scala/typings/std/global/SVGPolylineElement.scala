...
open class SVGPolylineElement ()
  extends StObject
     with typings.std.SVGPolylineElement {
  ...
  /* standard dom */
  /* CompleteClass */
  override val animatedPoints: org.scalajs.dom.SVGPointList = js.native
  ...
  /* standard dom */
  /* CompleteClass */
  override val points: org.scalajs.dom.SVGPointList = js.native
