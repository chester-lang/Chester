...
/* index */ NumberDictionary[Double] {
  ...
  /**
    ...
    */
  /* standard es5 */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): js.typedarray.Uint16Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any],
    thisArg: Any
  ...
  def slice(start: Unit, end: Double): js.typedarray.Uint16Array = js.native
  ...
  def subarray(begin: Unit, end: Double): js.typedarray.Uint16Array = js.native
