...
trait WindowEventHandlers extends StObject {
  ...
  def addEventListener_beforeunload(
    `type`: beforeunload,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.BeforeUnloadEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_beforeunload(
    `type`: beforeunload,
  ...
  def addEventListener_hashchange(
    `type`: hashchange,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.HashChangeEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_hashchange(
    `type`: hashchange,
  ...
  def addEventListener_popstate(
    `type`: popstate,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.PopStateEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_popstate(
    `type`: popstate,
  ...
  def addEventListener_storage(
    `type`: storage,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.StorageEvent, Any]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_storage(
    `type`: storage,
  ...
  /* standard dom */
  var onbeforeunload: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.BeforeUnloadEvent, Any]) | Null = js.native
  
  /* standard dom */
  var onhashchange: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.HashChangeEvent, Any]) | Null = js.native
  ...
  /* standard dom */
  var onpopstate: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.PopStateEvent, Any]) | Null = js.native
  
  /* standard dom */
  var onrejectionhandled: (js.ThisFunction1[/* this */ this.type, /* ev */ PromiseRejectionEvent, Any]) | Null = js.native
  
  /* standard dom */
  var onstorage: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.StorageEvent, Any]) | Null = js.native
