...
object URL {
  ...
  /* standard dom */
  inline def createObjectURL(`object`: Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("createObjectURL")(`object`.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
