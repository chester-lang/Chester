...
trait HTMLMediaElementEventMap
  ...
  /* standard dom */
  var waitingforkey: org.scalajs.dom.Event
}
object HTMLMediaElementEventMap {
  ...
  inline def apply(
    ...
    waitingforkey: org.scalajs.dom.Event,
  ...
  implicit open class MutableBuilder[Self <: HTMLMediaElementEventMap] (val x: Self) extends AnyVal {
    ...
    inline def setWaitingforkey(value: org.scalajs.dom.Event): Self = StObject.set(x, "waitingforkey", value.asInstanceOf[js.Any])
  }
}
