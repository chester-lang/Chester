...
/* Inlined {  dispatcher :undici-types.undici-types/dispatcher.default | undefined} & std.Omit<undici-types.undici-types/dispatcher.default.RequestOptions, 'origin' | 'path'> */
trait dispatcherdefaultundefineBlocking extends StObject {
...
object dispatcherdefaultundefineBlocking {
  
  inline def apply(method: HttpMethod): dispatcherdefaultundefineBlocking = {
    val __obj = js.Dynamic.literal(method = method.asInstanceOf[js.Any])
    __obj.asInstanceOf[dispatcherdefaultundefineBlocking]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: dispatcherdefaultundefineBlocking] (val x: Self) extends AnyVal {
