...
import typings.undiciTypes.mockInterceptorMod.MockInterceptor.MockDispatchData
...
object mockAgentMod {
  ...
  @JSImport("undici-types/mock-agent", JSImport.Default)
  @js.native
  open class default[TMockAgentOptions /* <: Options */] () extends MockAgent[TMockAgentOptions] {
  ...
  trait MockAgent[TMockAgentOptions /* <: Options */]
    ...
    def assertNoPendingInterceptors(options: typings.undiciTypes.anon.PendingInterceptorsFormatter): Unit = js.native
  ...
  object MockAgent {
    ...
    trait Options
      ...
      var agent: js.UndefOr[typings.undiciTypes.agentMod.default] = js.undefined
    }
    object Options {
      ...
      implicit open class MutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
        ...
        inline def setAgent(value: typings.undiciTypes.agentMod.default): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
