...
/* Inlined {  dispatcher :undici-types.undici-types/dispatcher.default | undefined} & std.Omit<undici-types.undici-types/dispatcher.default.RequestOptions, 'origin' | 'path' | 'method'> & std.Partial<std.Pick<undici-types.undici-types/dispatcher.default.RequestOptions, 'method'>> */
