...
/* Inlined {  dispatcher :undici-types.undici-types/dispatcher.default | undefined} & std.Omit<undici-types.undici-types/dispatcher.default.UpgradeOptions, 'origin' | 'path'> */
