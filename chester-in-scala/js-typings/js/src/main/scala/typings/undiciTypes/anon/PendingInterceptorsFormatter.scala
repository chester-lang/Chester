...
trait PendingInterceptorsFormatter extends StObject {
  ...
  var pendingInterceptorsFormatter: js.UndefOr[typings.undiciTypes.mockAgentMod.PendingInterceptorsFormatter] = js.undefined
}
object PendingInterceptorsFormatter {
  ...
  implicit open class MutableBuilder[Self <: PendingInterceptorsFormatter] (val x: Self) extends AnyVal {
    ...
    inline def setPendingInterceptorsFormatter(value: typings.undiciTypes.mockAgentMod.PendingInterceptorsFormatter): Self = StObject.set(x, "pendingInterceptorsFormatter", value.asInstanceOf[js.Any])
