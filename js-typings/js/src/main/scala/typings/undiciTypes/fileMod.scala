...
import typings.undiciTypes.undiciTypesStrings.native
import typings.undiciTypes.undiciTypesStrings.transparent
...
object fileMod {
  ...
  open class File protected ()
    ...
    def this(
      fileBits: js.Array[
            String | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify NodeJS.ArrayBufferView */ Any) | org.scalajs.dom.Blob
          ],
      fileName: String
    ) = this()
    def this(
