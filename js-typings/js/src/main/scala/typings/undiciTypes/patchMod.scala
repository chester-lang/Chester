...
object patchMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * You'll have to cast your way around this structure, unfortunately.
    * TS definition: {{{
    / * globalThis * / any extends {  EventTarget :infer T} ? T : {addEventListener (type : string, listener : any): void, addEventListener (type : string, listener : any, options : any): void, dispatchEvent (event : undici-types.undici-types/patch.Event): boolean, removeEventListener (type : string, listener : any): void, removeEventListener (type : string, listener : any, options : any): void, removeEventListener (type : string, listener : any, options : boolean): void}
    }}}
    */
  @js.native
