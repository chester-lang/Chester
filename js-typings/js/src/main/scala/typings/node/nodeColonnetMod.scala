...
import typings.node.childProcessMod._SendHandle
...
object nodeColonnetMod {
  ...
  /**
    ...
    * @since v19.4.0
    */
  inline def getDefaultAutoSelectFamily(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAutoSelectFamily")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def getDefaultAutoSelectFamilyAttemptTimeout(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultAutoSelectFamilyAttemptTimeout")().asInstanceOf[Double]
  ...
  /**
    ...
    * @since v19.4.0
    */
  inline def setDefaultAutoSelectFamily(value: Boolean): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaultAutoSelectFamily")(value.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    * @since v19.8.0, v18.8.0
    */
  inline def setDefaultAutoSelectFamilyAttemptTimeout(value: Double): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaultAutoSelectFamilyAttemptTimeout")(value.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
