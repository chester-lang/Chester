...
object bufferMod {
  ...
  open class Blob protected () extends StObject {
    /**
      ...
      */
    def this(sources: js.Array[js.typedarray.ArrayBuffer | BinaryLike | Blob]) = this()
    def this(sources: js.Array[js.typedarray.ArrayBuffer | BinaryLike | Blob], options: BlobOptions) = this()
    ...
    /**
      ...
      * ```
      */
    def bytes(): js.Promise[js.typedarray.Uint8Array] = js.native
  ...
  open class BufferCls protected ()
    ...
    def this(arrayBuffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ Any) = this()
    /**
  ...
  object global {
    ...
    @JSGlobal("Blob")
    @js.native
    def Blob: /* import warning: importer.ImportType#apply Failed type conversion: / * globalThis * / any extends {  onmessage :any,   Blob :infer T} ? T : new (sources : std.Array<std.ArrayBuffer | node.crypto.BinaryLike | node.buffer.Blob>, options : node.buffer.BlobOptions | undefined): node.buffer.Blob */ js.Any = js.native
    inline def Blob_=(
      x: /* import warning: importer.ImportType#apply Failed type conversion: / * globalThis * / any extends {  onmessage :any,   Blob :infer T} ? T : new (sources : std.Array<std.ArrayBuffer | node.crypto.BinaryLike | node.buffer.Blob>, options : node.buffer.BlobOptions | undefined): node.buffer.Blob */ js.Any
    ...
    /**
      ...
      */
    Instantiable1[
              (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ /* arrayBuffer */ Any) | (/* array */ js.Array[Any]) | (/* arrayBuffer */ js.typedarray.ArrayBuffer) | (/* buffer */ Buffer) | (/* size */ Double) | (/* str */ String) | (/* array */ js.typedarray.Uint8Array), 
              Buffer
            ]
      ...
      def alloc(size: Double, fill: js.typedarray.Uint8Array): Buffer = js.native
      def alloc(size: Double, fill: js.typedarray.Uint8Array, encoding: BufferEncoding): Buffer = js.native
      ...
      def byteLength(
        string: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ Any
      ): Double = js.native
      def byteLength(
        string: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ Any,
        encoding: BufferEncoding
      ): Double = js.native
      def byteLength(string: Buffer): Double = js.native
      def byteLength(string: Buffer, encoding: BufferEncoding): Double = js.native
      ...
      def from(
        arrayBuffer: WithImplicitCoercion[
              (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ Any) | js.Array[Double] | js.typedarray.ArrayBuffer | String | js.typedarray.Uint8Array
            ]
      ): Buffer = js.native
      def from(
        arrayBuffer: WithImplicitCoercion[
              js.typedarray.ArrayBuffer | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SharedArrayBuffer */ Any)
            ],
        byteOffset: Double
      ): Buffer = js.native
      def from(
    ...
    /* Rewritten from type alias, can be one of: 
      ...
      - typings.node.nodeStrings.`utf-16le`
    ...
    */
    ...
    object BufferEncoding {
      ...
      inline def `utf-16le`: typings.node.nodeStrings.`utf-16le` = "utf-16le".asInstanceOf[typings.node.nodeStrings.`utf-16le`]
  ...
  */
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    / * globalThis * / any extends {  onmessage :any,   Blob :any} ? {} : node.buffer.Blob
    }}}
    */
  type _Blob = Blob
}
