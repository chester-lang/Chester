...
trait SessionOptions extends StObject {
  ...
  var remoteCustomSettings: js.UndefOr[js.Array[Double]] = js.undefined
...
object SessionOptions {
  ...
  implicit open class MutableBuilder[Self <: SessionOptions] (val x: Self) extends AnyVal {
    ...
    inline def setRemoteCustomSettings(value: js.Array[Double]): Self = StObject.set(x, "remoteCustomSettings", value.asInstanceOf[js.Any])
    
    inline def setRemoteCustomSettingsUndefined: Self = StObject.set(x, "remoteCustomSettings", js.undefined)
    
    inline def setRemoteCustomSettingsVarargs(value: Double*): Self = StObject.set(x, "remoteCustomSettings", js.Array(value*))
