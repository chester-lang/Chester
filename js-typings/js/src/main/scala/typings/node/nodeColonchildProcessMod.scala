...
object nodeColonchildProcessMod {
  ...
  inline def fork(modulePath: URL): typings.node.childProcessMod.ChildProcess = ^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any]).asInstanceOf[typings.node.childProcessMod.ChildProcess]
  inline def fork(modulePath: URL, args: js.Array[String]): typings.node.childProcessMod.ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typings.node.childProcessMod.ChildProcess]
  inline def fork(modulePath: URL, args: js.Array[String], options: ForkOptions): typings.node.childProcessMod.ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.node.childProcessMod.ChildProcess]
  inline def fork(modulePath: URL, args: Unit, options: ForkOptions): typings.node.childProcessMod.ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.node.childProcessMod.ChildProcess]
  inline def fork(modulePath: URL, options: ForkOptions): typings.node.childProcessMod.ChildProcess = (^.asInstanceOf[js.Dynamic].applyDynamic("fork")(modulePath.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.node.childProcessMod.ChildProcess]
