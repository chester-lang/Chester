...
import typings.node.anon.Protocols
...
trait SecureContextOptions extends StObject {
  ...
  /**
    ...
    */
  var ALPNCallback: js.UndefOr[js.Function1[/* arg */ Protocols, js.UndefOr[String]]] = js.undefined
...
object SecureContextOptions {
  ...
  implicit open class MutableBuilder[Self <: SecureContextOptions] (val x: Self) extends AnyVal {
    ...
    inline def setALPNCallback(value: /* arg */ Protocols => js.UndefOr[String]): Self = StObject.set(x, "ALPNCallback", js.Any.fromFunction1(value))
    
    inline def setALPNCallbackUndefined: Self = StObject.set(x, "ALPNCallback", js.undefined)
