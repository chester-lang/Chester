...
import typings.node.anon.ObjectEncodingOptionsFlag_
...
object nodeColonfsMod {
  ...
  inline def createWriteStream(path: PathLike, options: WriteStreamOptions): typings.node.fsMod.WriteStream = (^.asInstanceOf[js.Dynamic].applyDynamic("createWriteStream")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.node.fsMod.WriteStream]
  ...
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def glob(
    pattern: String,
    options: GlobOptionsWithFileTypes,
    callback: js.Function2[
      /* err */ ErrnoException | Null, 
      /* matches */ js.Array[typings.node.fsMod.Dirent], 
      Unit
    ]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def glob(
    pattern: String,
  ...
  inline def glob(
    ...
    callback: js.Function2[
      /* err */ ErrnoException | Null, 
      /* matches */ js.Array[typings.node.fsMod.Dirent | String], 
      Unit
    ]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def glob(
  ...
  inline def globSync(pattern: String, options: GlobOptions): js.Array[typings.node.fsMod.Dirent | String] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.node.fsMod.Dirent | String]]
  inline def globSync(pattern: String, options: GlobOptionsWithFileTypes): js.Array[typings.node.fsMod.Dirent] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.node.fsMod.Dirent]]
  inline def globSync(pattern: String, options: GlobOptionsWithoutFileTypes): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def globSync(pattern: js.Array[String], options: GlobOptions): js.Array[typings.node.fsMod.Dirent | String] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.node.fsMod.Dirent | String]]
  inline def globSync(pattern: js.Array[String], options: GlobOptionsWithFileTypes): js.Array[typings.node.fsMod.Dirent] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.node.fsMod.Dirent]]
  inline def globSync(pattern: js.Array[String], options: GlobOptionsWithoutFileTypes): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def openAsBlob(path: PathLike): js.Promise[Blob] = ^.asInstanceOf[js.Dynamic].applyDynamic("openAsBlob")(path.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Blob]]
  inline def openAsBlob(path: PathLike, options: OpenAsBlobOptions): js.Promise[Blob] = (^.asInstanceOf[js.Dynamic].applyDynamic("openAsBlob")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Blob]]
  ...
  object promises {
    ...
    inline def appendFile(path: PathLike, data: String, options: ObjectEncodingOptionsFlag_): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFile")(path.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
    ...
    inline def appendFile(path: PathLike, data: js.typedarray.Uint8Array, options: ObjectEncodingOptionsFlag_): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFile")(path.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
    ...
    inline def appendFile(path: FileHandle, data: String, options: ObjectEncodingOptionsFlag_): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFile")(path.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
    ...
    inline def appendFile(path: FileHandle, data: js.typedarray.Uint8Array, options: ObjectEncodingOptionsFlag_): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("appendFile")(path.asInstanceOf[js.Any], data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
    ...
    object constants {
      ...
      // File Copy Constants
      /** Constant for fs.copyFile. Flag indicating the destination file should not be overwritten if it already exists. */
      @JSImport("node:fs", "promises.constants.COPYFILE_EXCL")
      @js.native
      val COPYFILE_EXCL: Double = js.native
      ...
      /**
        ...
        * If the underlying platform does not support copy-on-write, then a fallback copy mechanism is used.
        */
      @JSImport("node:fs", "promises.constants.COPYFILE_FICLONE")
      @js.native
      val COPYFILE_FICLONE: Double = js.native
      ...
      /**
        ...
        * If the underlying platform does not support copy-on-write, then the operation will fail with an error.
        */
      @JSImport("node:fs", "promises.constants.COPYFILE_FICLONE_FORCE")
      @js.native
      val COPYFILE_FICLONE_FORCE: Double = js.native
      
      // File Access Constants
      /** Constant for fs.access(). File is visible to the calling process. */
      @JSImport("node:fs", "promises.constants.F_OK")
      @js.native
      val F_OK: Double = js.native
      
      /** Constant for fs.open(). Flag indicating that data will be appended to the end of the file. */
      @JSImport("node:fs", "promises.constants.O_APPEND")
      @js.native
      val O_APPEND: Double = js.native
      
      /** Constant for fs.open(). Flag indicating to create the file if it does not already exist. */
      @JSImport("node:fs", "promises.constants.O_CREAT")
      @js.native
      val O_CREAT: Double = js.native
      
      /** Constant for fs.open(). When set, an attempt will be made to minimize caching effects of file I/O. */
      @JSImport("node:fs", "promises.constants.O_DIRECT")
      @js.native
      val O_DIRECT: Double = js.native
      
      /** Constant for fs.open(). Flag indicating that the open should fail if the path is not a directory. */
      @JSImport("node:fs", "promises.constants.O_DIRECTORY")
      @js.native
      val O_DIRECTORY: Double = js.native
      
      /** Constant for fs.open(). Flag indicating that the file is opened for synchronous I/O with write operations waiting for data integrity. */
      @JSImport("node:fs", "promises.constants.O_DSYNC")
      @js.native
      val O_DSYNC: Double = js.native
      
      /** Constant for fs.open(). Flag indicating that opening a file should fail if the O_CREAT flag is set and the file already exists. */
      @JSImport("node:fs", "promises.constants.O_EXCL")
      @js.native
      val O_EXCL: Double = js.native
      ...
      /**
        ...
        * This flag is available on Linux operating systems only.
        */
      @JSImport("node:fs", "promises.constants.O_NOATIME")
      @js.native
      val O_NOATIME: Double = js.native
      ...
      /**
        ...
        * (if the process does not already have one).
        */
      @JSImport("node:fs", "promises.constants.O_NOCTTY")
      @js.native
      val O_NOCTTY: Double = js.native
      
      /** Constant for fs.open(). Flag indicating that the open should fail if the path is a symbolic link. */
      @JSImport("node:fs", "promises.constants.O_NOFOLLOW")
      @js.native
      val O_NOFOLLOW: Double = js.native
      
      /** Constant for fs.open(). Flag indicating to open the file in nonblocking mode when possible. */
      @JSImport("node:fs", "promises.constants.O_NONBLOCK")
      @js.native
      val O_NONBLOCK: Double = js.native
      
      // File Open Constants
      /** Constant for fs.open(). Flag indicating to open a file for read-only access. */
      @JSImport("node:fs", "promises.constants.O_RDONLY")
      @js.native
      val O_RDONLY: Double = js.native
      
      /** Constant for fs.open(). Flag indicating to open a file for read-write access. */
      @JSImport("node:fs", "promises.constants.O_RDWR")
      @js.native
      val O_RDWR: Double = js.native
      
      /** Constant for fs.open(). Flag indicating to open the symbolic link itself rather than the resource it is pointing to. */
      @JSImport("node:fs", "promises.constants.O_SYMLINK")
      @js.native
      val O_SYMLINK: Double = js.native
      
      /** Constant for fs.open(). Flag indicating that the file is opened for synchronous I/O. */
      @JSImport("node:fs", "promises.constants.O_SYNC")
      @js.native
      val O_SYNC: Double = js.native
      
      /** Constant for fs.open(). Flag indicating that if the file exists and is a regular file, and the file is opened successfully for write access, its length shall be truncated to zero. */
      @JSImport("node:fs", "promises.constants.O_TRUNC")
      @js.native
      val O_TRUNC: Double = js.native
      
      /** Constant for fs.open(). Flag indicating to open a file for write-only access. */
      @JSImport("node:fs", "promises.constants.O_WRONLY")
      @js.native
      val O_WRONLY: Double = js.native
      
      /** Constant for fs.access(). File can be read by the calling process. */
      @JSImport("node:fs", "promises.constants.R_OK")
      @js.native
      val R_OK: Double = js.native
      
      /** Constant for fs.Stats mode property for determining a file's type. File type constant for a block-oriented device file. */
      @JSImport("node:fs", "promises.constants.S_IFBLK")
      @js.native
      val S_IFBLK: Double = js.native
      
      /** Constant for fs.Stats mode property for determining a file's type. File type constant for a character-oriented device file. */
      @JSImport("node:fs", "promises.constants.S_IFCHR")
      @js.native
      val S_IFCHR: Double = js.native
      
      /** Constant for fs.Stats mode property for determining a file's type. File type constant for a directory. */
      @JSImport("node:fs", "promises.constants.S_IFDIR")
      @js.native
      val S_IFDIR: Double = js.native
      
      /** Constant for fs.Stats mode property for determining a file's type. File type constant for a FIFO/pipe. */
      @JSImport("node:fs", "promises.constants.S_IFIFO")
      @js.native
      val S_IFIFO: Double = js.native
      
      /** Constant for fs.Stats mode property for determining a file's type. File type constant for a symbolic link. */
      @JSImport("node:fs", "promises.constants.S_IFLNK")
      @js.native
      val S_IFLNK: Double = js.native
      
      // File Type Constants
      /** Constant for fs.Stats mode property for determining a file's type. Bit mask used to extract the file type code. */
      @JSImport("node:fs", "promises.constants.S_IFMT")
      @js.native
      val S_IFMT: Double = js.native
      
      /** Constant for fs.Stats mode property for determining a file's type. File type constant for a regular file. */
      @JSImport("node:fs", "promises.constants.S_IFREG")
      @js.native
      val S_IFREG: Double = js.native
      
      /** Constant for fs.Stats mode property for determining a file's type. File type constant for a socket. */
      @JSImport("node:fs", "promises.constants.S_IFSOCK")
      @js.native
      val S_IFSOCK: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating readable by group. */
      @JSImport("node:fs", "promises.constants.S_IRGRP")
      @js.native
      val S_IRGRP: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating readable by others. */
      @JSImport("node:fs", "promises.constants.S_IROTH")
      @js.native
      val S_IROTH: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating readable by owner. */
      @JSImport("node:fs", "promises.constants.S_IRUSR")
      @js.native
      val S_IRUSR: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating readable, writable and executable by group. */
      @JSImport("node:fs", "promises.constants.S_IRWXG")
      @js.native
      val S_IRWXG: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating readable, writable and executable by others. */
      @JSImport("node:fs", "promises.constants.S_IRWXO")
      @js.native
      val S_IRWXO: Double = js.native
      
      // File Mode Constants
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating readable, writable and executable by owner. */
      @JSImport("node:fs", "promises.constants.S_IRWXU")
      @js.native
      val S_IRWXU: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating writable by group. */
      @JSImport("node:fs", "promises.constants.S_IWGRP")
      @js.native
      val S_IWGRP: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating writable by others. */
      @JSImport("node:fs", "promises.constants.S_IWOTH")
      @js.native
      val S_IWOTH: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating writable by owner. */
      @JSImport("node:fs", "promises.constants.S_IWUSR")
      @js.native
      val S_IWUSR: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating executable by group. */
      @JSImport("node:fs", "promises.constants.S_IXGRP")
      @js.native
      val S_IXGRP: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating executable by others. */
      @JSImport("node:fs", "promises.constants.S_IXOTH")
      @js.native
      val S_IXOTH: Double = js.native
      
      /** Constant for fs.Stats mode property for determining access permissions for a file. File mode indicating executable by owner. */
      @JSImport("node:fs", "promises.constants.S_IXUSR")
      @js.native
      val S_IXUSR: Double = js.native
      ...
      /**
        ...
        * this flag is ignored.
        */
      @JSImport("node:fs", "promises.constants.UV_FS_O_FILEMAP")
      @js.native
      val UV_FS_O_FILEMAP: Double = js.native
      
      /** Constant for fs.access(). File can be written by the calling process. */
      @JSImport("node:fs", "promises.constants.W_OK")
      @js.native
      val W_OK: Double = js.native
      
      /** Constant for fs.access(). File can be executed by the calling process. */
      @JSImport("node:fs", "promises.constants.X_OK")
      @js.native
      val X_OK: Double = js.native
    }
    ...
    /**
      ...
      */
    inline def glob(pattern: String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def glob(pattern: String, opt: GlobOptions): /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterableIterator<Dirent> */ Any = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterableIterator<Dirent> */ Any]
    inline def glob(pattern: String, opt: GlobOptionsWithFileTypes): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def glob(pattern: String, opt: GlobOptionsWithoutFileTypes): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def glob(pattern: js.Array[String]): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def glob(pattern: js.Array[String], opt: GlobOptions): /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterableIterator<Dirent> */ Any = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterableIterator<Dirent> */ Any]
    inline def glob(pattern: js.Array[String], opt: GlobOptionsWithFileTypes): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def glob(pattern: js.Array[String], opt: GlobOptionsWithoutFileTypes): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("glob")(pattern.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    /**
      ...
      */
    inline def watch(filename: PathLike): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("watch")(filename.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def watch(filename: PathLike, options: String): /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterable<FileChangeInfo<string>> */ Any = (^.asInstanceOf[js.Dynamic].applyDynamic("watch")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterable<FileChangeInfo<string>> */ Any]
    /**
      ...
      */
    inline def watch(filename: PathLike, options: WatchOptionsencodingbuffe): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("watch")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def watch(filename: PathLike, options: BufferEncoding): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("watch")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
    /**
      * Watch for changes on `filename`, where `filename` is either a file or a directory, returning an `FSWatcher`.
      * @param filename A path to a file or directory. If a URL is provided, it must use the `file:` protocol.
      * @param options Either the encoding for the filename provided to the listener, or an object optionally specifying encoding, persistent, and recursive options.
      ...
      * If `recursive` is not supplied, the default of `false` is used.
      */
    inline def watch(filename: PathLike, options: WatchOptions): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("watch")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
    
    inline def watch_buffer(filename: PathLike, options: buffer_): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("watch")(filename.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    ): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFile")(file.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
    inline def writeFile(
      file: PathLike,
      data: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterable<string | NodeJS.ArrayBufferView> */ Any,
