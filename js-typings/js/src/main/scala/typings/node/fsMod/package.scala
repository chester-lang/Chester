...
inline def createWriteStream(path: PathLike, options: WriteStreamOptions): WriteStream = (^.asInstanceOf[js.Dynamic].applyDynamic("createWriteStream")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[WriteStream]
...
inline def globSync(pattern: String, options: GlobOptions): js.Array[Dirent | String] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[Dirent | String]]
inline def globSync(pattern: String, options: GlobOptionsWithFileTypes): js.Array[Dirent] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[Dirent]]
...
inline def globSync(pattern: js.Array[String], options: GlobOptions): js.Array[Dirent | String] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[Dirent | String]]
inline def globSync(pattern: js.Array[String], options: GlobOptionsWithFileTypes): js.Array[Dirent] = (^.asInstanceOf[js.Dynamic].applyDynamic("globSync")(pattern.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[Dirent]]
...
inline def statfs(path: PathLike, callback: js.Function2[/* err */ ErrnoException | Null, /* stats */ StatsFs, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("statfs")(path.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def statfs(
  path: PathLike,
  options: Unit,
...
inline def statfsSync(path: PathLike): StatsFs = ^.asInstanceOf[js.Dynamic].applyDynamic("statfsSync")(path.asInstanceOf[js.Any]).asInstanceOf[StatsFs]
inline def statfsSync(path: PathLike, options: StatFsOptionsbigintfalseu): StatsFs = (^.asInstanceOf[js.Dynamic].applyDynamic("statfsSync")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StatsFs]
...
inline def statfsSync(path: PathLike, options: StatFsOptions): StatsFs | BigIntStatsFs = (^.asInstanceOf[js.Dynamic].applyDynamic("statfsSync")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StatsFs | BigIntStatsFs]

inline def statfsSync_Union(path: PathLike): StatsFs | BigIntStatsFs = ^.asInstanceOf[js.Dynamic].applyDynamic("statfsSync")(path.asInstanceOf[js.Any]).asInstanceOf[StatsFs | BigIntStatsFs]
...
type BigIntStatsFs = StatsFsBase[js.BigInt]

type BigIntStatsListener = js.Function2[/* curr */ BigIntStats, /* prev */ BigIntStats, Unit]
...
type StatsListener = js.Function2[/* curr */ Stats, /* prev */ Stats, Unit]

type TimeLike = String | Double | js.Date

type WatchListener[T] = js.Function2[/* event */ WatchEventType, /* filename */ T | Null, Unit]
