...
object domainMod {
  ...
  open class Domain () extends StObject {
    ...
    /**
      ...
      */
    def add(emitter: typings.node.nodeColoneventsMod.^[DefaultEventMap]): Unit = js.native
    ...
    /**
      ...
      * to the domain.
      */
    var members: js.Array[typings.node.nodeColoneventsMod.^[DefaultEventMap] | Timer] = js.native
    ...
    /**
      ...
      */
    def remove(emitter: typings.node.nodeColoneventsMod.^[DefaultEventMap]): Unit = js.native
