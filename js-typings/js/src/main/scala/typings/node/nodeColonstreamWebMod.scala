...
import typings.node.streamWebMod.CompressionStream
import typings.node.streamWebMod.CountQueuingStrategy
import typings.node.streamWebMod.DecompressionStream
...
object nodeColonstreamWebMod {
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("node:stream/web", "CompressionStream")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("node:stream/web", "DecompressionStream")
  @js.native
  open class DecompressionStreamCls[R, W] protected ()
    extends StObject
       with DecompressionStream[R, W] {
    def this(format: deflate | `deflate-raw` | gzip) = this()
  ...
  object ReadableStream {
    ...
    inline def from[T](iterable: js.Iterable[T]): typings.node.streamWebMod.ReadableStream[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.node.streamWebMod.ReadableStream[T]]
    inline def from[T](
      iterable: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncIterable<T> */ Any
    ): typings.node.streamWebMod.ReadableStream[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.node.streamWebMod.ReadableStream[T]]
  }
  ...
  open class TextDecoderStreamCls ()
    ...
    def this(encoding: String, options: TextDecoderOptions) = this()
    def this(encoding: Unit, options: TextDecoderOptions) = this()
  }
