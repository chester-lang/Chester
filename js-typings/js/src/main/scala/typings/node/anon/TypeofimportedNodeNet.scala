...
@js.native
trait TypeofimportedNodeNet extends StObject {
  ...
  /**
    ...
    */
  var BlockList: Instantiable0[typings.node.nodeColonnetMod.BlockList] = js.native
  ...
  /**
    ...
    */
  var SocketAddress: Instantiable1[/* options */ SocketAddressInitOptions, typings.node.nodeColonnetMod.SocketAddress] = js.native
