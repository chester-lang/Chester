...
@js.native
trait TypeofimportedNodeStrea extends StObject {
  ...
  /**
    ...
    * @since v0.9.4
    */
  var Duplex: Instantiable1[/* opts */ js.UndefOr[DuplexOptions], typings.node.nodeColonstreamMod.Duplex] = js.native
  
  /**
    * The `stream.PassThrough` class is a trivial implementation of a `Transform` stream that simply passes the input bytes across to the output. Its purpose is
    * primarily for examples and testing, but there are some use cases where `stream.PassThrough` is useful as a building block for novel sorts of streams.
    */
  var PassThrough: Instantiable0[typings.node.nodeColonstreamMod.PassThrough] = js.native
  
  /**
    * @since v0.9.4
    */
  var Readable: Instantiable0[typings.node.nodeColonstreamMod.Readable] = js.native
  
  val ReadableBase: Any = js.native
  
  var Stream: Instantiable1[/* opts */ js.UndefOr[ReadableOptions], typings.node.nodeColonstreamMod.Stream] = js.native
  ...
  /**
    ...
    * @since v0.9.4
    */
  var Transform: Instantiable1[/* opts */ js.UndefOr[TransformOptions], typings.node.nodeColonstreamMod.Transform] = js.native
  
  /**
    * @since v0.9.4
    */
  var Writable: Instantiable0[typings.node.nodeColonstreamMod.Writable] = js.native
