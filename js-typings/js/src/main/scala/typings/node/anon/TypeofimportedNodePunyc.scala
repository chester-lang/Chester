...
trait TypeofimportedNodePunyc extends StObject {
...
object TypeofimportedNodePunyc {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedNodePunyc]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedNodePunyc] (val x: Self) extends AnyVal {
