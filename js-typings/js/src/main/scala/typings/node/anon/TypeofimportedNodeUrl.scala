...
@js.native
trait TypeofimportedNodeUrl extends StObject {
  ...
  /**
    ...
    */
  var URL: Instantiable2[
    /* input */ String | ToString, 
    /* base */ js.UndefOr[String | URL_], 
  ...
  var URLSearchParams: Instantiable1[
    ...
    typings.node.nodeColonurlMod.URLSearchParams
  ] = js.native
  ...
  def fileURLToPath(url: String, options: FileUrlToPathOptions): String = js.native
  def fileURLToPath(url: URL_): String = js.native
  def fileURLToPath(url: URL_, options: FileUrlToPathOptions): String = js.native
  ...
  def pathToFileURL(path: String, options: PathToFileUrlOptions): URL_ = js.native
