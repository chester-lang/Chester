...
trait TypeofconstantsCOPYFILEEXCL extends StObject {
...
object TypeofconstantsCOPYFILEEXCL {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofconstantsCOPYFILEEXCL]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofconstantsCOPYFILEEXCL] (val x: Self) extends AnyVal {
