...
@js.native
trait TypeofimportedNodeRepl extends StObject {
  ...
  /**
    ...
    * @since v0.1.91
    */
  var REPLServer: Instantiable0[typings.node.nodeColonreplMod.REPLServer] = js.native
  ...
  /**
    ...
    */
  var Recoverable: Instantiable1[/* err */ js.Error, typings.node.nodeColonreplMod.Recoverable] = js.native
