...
trait TypeofimportedNodeTrace extends StObject {
...
object TypeofimportedNodeTrace {
  
  inline def apply(createTracing: CreateTracingOptions => Tracing, getEnabledCategories: () => js.UndefOr[String]): TypeofimportedNodeTrace = {
    ...
    __obj.asInstanceOf[TypeofimportedNodeTrace]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedNodeTrace] (val x: Self) extends AnyVal {
