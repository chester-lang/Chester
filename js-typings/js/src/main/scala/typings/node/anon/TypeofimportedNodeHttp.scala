...
@js.native
trait TypeofimportedNodeHttp extends StObject {
  ...
  /**
    ...
    * @since v0.3.4
    */
  var Agent: Instantiable1[/* opts */ js.UndefOr[AgentOptions], typings.node.nodeColonhttpMod.Agent] = js.native
  ...
  /**
    ...
    * @since v0.1.17
    */
  var ClientRequest: Instantiable2[
    /* url */ String | URL | ClientRequestArgs, 
    /* cb */ js.UndefOr[js.Function1[/* res */ IncomingMessage, Unit]], 
    typings.node.nodeColonhttpMod.ClientRequest
  ] = js.native
  ...
  /**
    ...
    * @since v0.1.17
    */
  var IncomingMessage: Instantiable1[/* socket */ Socket, typings.node.nodeColonhttpMod.IncomingMessage] = js.native
  ...
  /**
    ...
    * @since v0.1.17
    */
  var OutgoingMessage: Instantiable0[typings.node.nodeColonhttpMod.OutgoingMessage[IncomingMessage]] = js.native
  
  val STATUS_CODES: StringDictionary[js.UndefOr[String]] & NumberDictionary[js.UndefOr[String]] = js.native
  
  /**
    * @since v0.1.17
    */
  var Server: Instantiable1[
    /* requestListener */ js.UndefOr[
      RequestListener[
        /* import warning: RewrittenClass.unapply cls was tparam Request */ Any, 
        /* import warning: RewrittenClass.unapply cls was tparam Response */ Any
      ]
    ], 
    typings.node.nodeColonhttpMod.Server[
      /* import warning: importer.ImportType#apply Failed type conversion: typeof IncomingMessage */ js.Any, 
      /* import warning: importer.ImportType#apply Failed type conversion: typeof ServerResponse */ js.Any
    ]
  ] = js.native
  ...
  /**
    ...
    * @since v0.1.13
    */
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof ServerResponse */ js.Any */](): Server[Request, Response] = js.native
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof ServerResponse */ js.Any */](options: ServerOptions[Request, Response]): Server[Request, Response] = js.native
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof ServerResponse */ js.Any */](options: ServerOptions[Request, Response], requestListener: RequestListener[Request, Response]): Server[Request, Response] = js.native
  def createServer[Request /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof IncomingMessage */ js.Any */, Response /* <: /* import warning: importer.ImportType#apply Failed type conversion: typeof ServerResponse */ js.Any */](requestListener: RequestListener[Request, Response]): Server[Request, Response] = js.native
