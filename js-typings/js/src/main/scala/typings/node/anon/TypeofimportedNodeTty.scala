...
import typings.node.nodeColonttyMod.ReadStream
import typings.node.nodeColonttyMod.WriteStream
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofimportedNodeTty extends StObject {
  ...
  var ReadStream: Instantiable2[
    ...
    typings.node.nodeColonttyMod.ReadStream
  ]
  ...
  /**
    ...
    * @since v0.5.8
    */
  var WriteStream: Instantiable1[/* fd */ Double, typings.node.nodeColonttyMod.WriteStream]
...
object TypeofimportedNodeTty {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedNodeTty]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedNodeTty] (val x: Self) extends AnyVal {
