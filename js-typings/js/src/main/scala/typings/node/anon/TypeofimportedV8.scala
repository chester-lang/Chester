...
@js.native
trait TypeofimportedV8 extends StObject {
  
  /**
    * A subclass of `Deserializer` corresponding to the format written by `DefaultSerializer`.
    * @since v8.0.0
    */
  var DefaultDeserializer: Instantiable0[typings.node.v8Mod.DefaultDeserializer] = js.native
  ...
  /**
    ...
    * @since v8.0.0
    */
  var DefaultSerializer: Instantiable0[typings.node.v8Mod.DefaultSerializer] = js.native
  
  /**
    * @since v8.0.0
    */
  var Deserializer: Instantiable1[/* data */ TypedArray, typings.node.v8Mod.Deserializer] = js.native
  
  /**
    * This API collects GC data in current thread.
    * @since v19.6.0, v18.15.0
    */
  var GCProfiler: Instantiable0[typings.node.v8Mod.GCProfiler] = js.native
  
  /**
    * @since v8.0.0
    */
  var Serializer: Instantiable0[typings.node.v8Mod.Serializer] = js.native
