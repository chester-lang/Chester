...
@js.native
trait TypeofimportedHttp extends StObject {
  ...
  /**
    ...
    * @since v0.3.4
    */
  var Agent: Instantiable1[/* opts */ js.UndefOr[AgentOptions], typings.node.httpMod.Agent] = js.native
  ...
  var ClientRequest: Instantiable2[
    ...
    typings.node.httpMod.ClientRequest
  ] = js.native
