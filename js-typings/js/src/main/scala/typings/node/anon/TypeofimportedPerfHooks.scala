...
@js.native
trait TypeofimportedPerfHooks extends StObject {
  
  /**
    * The constructor of this class is not exposed to users directly.
    * @since v8.5.0
    */
  var PerformanceEntry: Instantiable0[typings.node.perfHooksMod.PerformanceEntry] = js.native
  
  /**
    * Exposes marks created via the `Performance.mark()` method.
    * @since v18.2.0, v16.17.0
    */
  var PerformanceMark: Instantiable0[typings.node.perfHooksMod.PerformanceMark] = js.native
  ...
  /**
    ...
    * @since v18.2.0, v16.17.0
    */
  var PerformanceMeasure: Instantiable0[typings.node.perfHooksMod.PerformanceMeasure] = js.native
  ...
  /**
    ...
    * @since v8.5.0
    */
  var PerformanceNodeTiming: Instantiable0[typings.node.perfHooksMod.PerformanceNodeTiming] = js.native
  ...
  var PerformanceObserver: Instantiable1[
    ...
    typings.node.perfHooksMod.PerformanceObserver
  ] = js.native
  
  var PerformanceObserverEntryList: Instantiable0[typings.node.perfHooksMod.PerformanceObserverEntryList] = js.native
  ...
  /**
    ...
    * @since v18.2.0, v16.17.0
    */
  var PerformanceResourceTiming: Instantiable0[typings.node.perfHooksMod.PerformanceResourceTiming] = js.native
