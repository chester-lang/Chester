...
@JSImport("vm", "Module")
@js.native
open class Module () extends StObject {
  ...
  /**
    ...
    */
  var dependencySpecifiers: js.Array[String] = js.native
  ...
  /**
    ...
    */
  def evaluate(): js.Promise[Unit] = js.native
  def evaluate(options: ModuleEvaluateOptions): js.Promise[Unit] = js.native
  ...
  /**
    ...
    * the ECMAScript specification.
    */
  def link(linker: ModuleLinker): js.Promise[Unit] = js.native
  ...
  /**
    ...
    * specification.
    */
  var namespace: js.Object = js.native
  ...
  /**
    ...
    */
  var status: ModuleStatus = js.native
}
