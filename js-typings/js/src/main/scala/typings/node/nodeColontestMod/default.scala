...
object default {
  ...
  inline def apply(name: Unit, fn: TestFn): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].apply(name.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  ...
  @JSImport("node:test", JSImport.Default)
  @js.native
