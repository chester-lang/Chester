...
import typings.node.anon.Typeof_URL
...
object urlMod {
  ...
  open class URLSearchParams ()
    ...
    def has(name: String, value: String): Boolean = js.native
  ...
  open class URL_ protected () extends StObject {
    ...
    def this(input: ToString, base: String) = this()
    def this(input: ToString, base: URL_) = this()
  ...
  object URL_ {
    ...
    /**
      ...
      */
    /* static member */
    inline def canParse(input: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("canParse")(input.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    inline def canParse(input: String, base: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("canParse")(input.asInstanceOf[js.Any], base.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /**
      ...
      */
    /* static member */
    inline def parse(input: String): URL_ | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[URL_ | Null]
    inline def parse(input: String, base: String): URL_ | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any], base.asInstanceOf[js.Any])).asInstanceOf[URL_ | Null]
    ...
    /**
      ...
      */
    /* static member */
    inline def revokeObjectURL(id: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("revokeObjectURL")(id.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
  ...
  inline def fileURLToPath(url: String, options: FileUrlToPathOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("fileURLToPath")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def fileURLToPath(url: URL_, options: FileUrlToPathOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("fileURLToPath")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  object global {
    ...
    @JSGlobal("URL")
    @js.native
    def URL: /* import warning: importer.ImportType#apply Failed type conversion: / * globalThis * / any extends {  onmessage :any,   URL :infer T} ? T : {readonly createObjectURL (blob : node.node:buffer.Blob): string, readonly revokeObjectURL (id : string): void, readonly canParse (input : string): boolean, readonly canParse (input : string, base : string): boolean, readonly parse (input : string): node.url.URL | null, readonly parse (input : string, base : string): node.url.URL | null} & new (input : string | {toString (): string}, base : string | node.url.URL | undefined): node.url.URL */ js.Any = js.native
    ...
    inline def URL_=(
      x: /* import warning: importer.ImportType#apply Failed type conversion: / * globalThis * / any extends {  onmessage :any,   URL :infer T} ? T : {readonly createObjectURL (blob : node.node:buffer.Blob): string, readonly revokeObjectURL (id : string): void, readonly canParse (input : string): boolean, readonly canParse (input : string, base : string): boolean, readonly parse (input : string): node.url.URL | null, readonly parse (input : string, base : string): node.url.URL | null} & new (input : string | {toString (): string}, base : string | node.url.URL | undefined): node.url.URL */ js.Any
    ): Unit = js.Dynamic.global.updateDynamic("URL")(x.asInstanceOf[js.Any])
    
    trait Global extends StObject {
      
      var URL: Typeof_URL & (Instantiable2[/* input */ String | ToString, /* base */ js.UndefOr[String | URL_], URL_])
    ...
    object Global {
      ...
      inline def apply(
        URL: Typeof_URL & (Instantiable2[/* input */ String | ToString, /* base */ js.UndefOr[String | URL_], URL_]),
      ...
      implicit open class MutableBuilder[Self <: Global] (val x: Self) extends AnyVal {
        ...
        inline def setURL(
          value: Typeof_URL & (Instantiable2[/* input */ String | ToString, /* base */ js.UndefOr[String | URL_], URL_])
  ...
  inline def pathToFileURL(path: String, options: PathToFileUrlOptions): URL_ = (^.asInstanceOf[js.Dynamic].applyDynamic("pathToFileURL")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[URL_]
  ...
  trait FileUrlToPathOptions extends StObject {
  ...
  object FileUrlToPathOptions {
    
    inline def apply(): FileUrlToPathOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FileUrlToPathOptions]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: FileUrlToPathOptions] (val x: Self) extends AnyVal {
  ...
  trait PathToFileUrlOptions extends StObject {
  ...
  object PathToFileUrlOptions {
    
    inline def apply(): PathToFileUrlOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PathToFileUrlOptions]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PathToFileUrlOptions] (val x: Self) extends AnyVal {
