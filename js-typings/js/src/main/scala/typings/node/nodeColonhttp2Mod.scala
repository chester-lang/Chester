...
object nodeColonhttp2Mod {
  ...
  object constants {
    ...
    @JSImport("node:http2", "constants.HTTP2_HEADER_ACCESS_CONTROL_ALLOW_CREDENTIALS")
    @js.native
    val HTTP2_HEADER_ACCESS_CONTROL_ALLOW_CREDENTIALS: String = js.native
    
    @JSImport("node:http2", "constants.HTTP2_HEADER_ACCESS_CONTROL_ALLOW_HEADERS")
    @js.native
    val HTTP2_HEADER_ACCESS_CONTROL_ALLOW_HEADERS: String = js.native
    
    @JSImport("node:http2", "constants.HTTP2_HEADER_ACCESS_CONTROL_ALLOW_METHODS")
    @js.native
    ...
    @JSImport("node:http2", "constants.HTTP2_HEADER_ACCESS_CONTROL_EXPOSE_HEADERS")
    @js.native
    val HTTP2_HEADER_ACCESS_CONTROL_EXPOSE_HEADERS: String = js.native
    
    @JSImport("node:http2", "constants.HTTP2_HEADER_ACCESS_CONTROL_REQUEST_HEADERS")
    @js.native
    val HTTP2_HEADER_ACCESS_CONTROL_REQUEST_HEADERS: String = js.native
    
    @JSImport("node:http2", "constants.HTTP2_HEADER_ACCESS_CONTROL_REQUEST_METHOD")
    @js.native
  ...
  inline def performServerHandshake(socket: Duplex): ServerHttp2Session = ^.asInstanceOf[js.Dynamic].applyDynamic("performServerHandshake")(socket.asInstanceOf[js.Any]).asInstanceOf[ServerHttp2Session]
  inline def performServerHandshake(socket: Duplex, options: ServerOptions): ServerHttp2Session = (^.asInstanceOf[js.Dynamic].applyDynamic("performServerHandshake")(socket.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ServerHttp2Session]
