...
object nodeColonosMod {
  ...
  object constants {
    ...
    object dlopen {
      ...
      @JSImport("node:os", "constants.dlopen.RTLD_DEEPBIND")
      @js.native
      val RTLD_DEEPBIND: Double = js.native
      
      @JSImport("node:os", "constants.dlopen.RTLD_GLOBAL")
      @js.native
      val RTLD_GLOBAL: Double = js.native
      
      @JSImport("node:os", "constants.dlopen.RTLD_LAZY")
      @js.native
      val RTLD_LAZY: Double = js.native
      
      @JSImport("node:os", "constants.dlopen.RTLD_LOCAL")
      @js.native
      val RTLD_LOCAL: Double = js.native
      
      @JSImport("node:os", "constants.dlopen.RTLD_NOW")
      @js.native
