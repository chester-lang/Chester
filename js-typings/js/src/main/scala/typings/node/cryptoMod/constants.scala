...
object constants {
  ...
  @JSImport("crypto", "constants.SSL_OP_NO_TLSv1_3")
  @js.native
  ...
  @JSImport("crypto", "constants.SSL_OP_ALLOW_NO_DHE_KEX")
  @js.native
  ...
  @JSImport("crypto", "constants.SSL_OP_NO_ENCRYPT_THEN_MAC")
  @js.native
  ...
  @JSImport("crypto", "constants.SSL_OP_NO_RENEGOTIATION")
  @js.native
  ...
  @JSImport("crypto", "constants.SSL_OP_PRIORITIZE_CHACHA")
  @js.native
