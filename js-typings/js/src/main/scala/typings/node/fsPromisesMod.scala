...
import typings.node.anon.ObjectEncodingOptionsFlagEncoding_
...
object fsPromisesMod {
  ...
  object FileChangeInfo {
    ...
    inline def apply[T /* <: String | Buffer */](eventType: WatchEventType): FileChangeInfo[T] = {
      val __obj = js.Dynamic.literal(eventType = eventType.asInstanceOf[js.Any], filename = null)
  ...
  trait FileHandle
    ...
    def appendFile(data: String, options: ObjectEncodingOptionsFlag_): js.Promise[Unit] = js.native
    ...
    def appendFile(data: js.typedarray.Uint8Array, options: ObjectEncodingOptionsFlag_): js.Promise[Unit] = js.native
    ...
    def read(buffer: RelativeIndexable[js.BigInt]): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Double, length: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Double, length: Double, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Double, length: Null, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Double, length: Unit, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Null, length: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Null, length: Double, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Null, length: Null, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Null, length: Unit, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Unit, length: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Unit, length: Double, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Unit, length: Null, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    def read(buffer: RelativeIndexable[js.BigInt], offset: Unit, length: Unit, position: Double): js.Promise[FileReadResult[RelativeIndexable[js.BigInt]]] = js.native
    ...
    def readableWebStream(options: ReadableWebStreamOptions): ReadableStream[Any] = js.native
    ...
    def writeFile(data: String, options: ObjectEncodingOptionsFlagEncoding_): js.Promise[Unit] = js.native
    ...
    def writeFile(data: js.typedarray.Uint8Array, options: ObjectEncodingOptionsFlagEncoding_): js.Promise[Unit] = js.native
  ...
  trait ReadableWebStreamOptions extends StObject {
    
    /**
      * Whether to open a normal or a `'bytes'` stream.
      * @since v20.0.0
      */
    var `type`: js.UndefOr[bytes] = js.undefined
  }
  object ReadableWebStreamOptions {
    
    inline def apply(): ReadableWebStreamOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ReadableWebStreamOptions]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ReadableWebStreamOptions] (val x: Self) extends AnyVal {
