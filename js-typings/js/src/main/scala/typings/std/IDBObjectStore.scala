...
trait IDBObjectStore extends StObject {
  ...
  def delete(key: org.scalajs.dom.IDBKeyRange): org.scalajs.dom.IDBRequest[Any, Unit] = js.native
  /**
    ...
    */
  /* standard dom */
  def delete(key: IDBValidKey): org.scalajs.dom.IDBRequest[Any, Unit] = js.native
  ...
  def get(query: org.scalajs.dom.IDBKeyRange): org.scalajs.dom.IDBRequest[Any, js.UndefOr[Any]] = js.native
  /**
    ...
    */
  /* standard dom */
  def get(query: IDBValidKey): org.scalajs.dom.IDBRequest[Any, js.UndefOr[Any]] = js.native
