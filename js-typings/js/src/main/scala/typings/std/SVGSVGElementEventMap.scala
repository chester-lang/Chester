...
trait SVGSVGElementEventMap
  ...
  /* standard dom */
  var SVGUnload: org.scalajs.dom.Event
...
object SVGSVGElementEventMap {
  ...
  inline def apply(
    SVGUnload: org.scalajs.dom.Event,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGSVGElementEventMap] (val x: Self) extends AnyVal {
    
    inline def setSVGUnload(value: org.scalajs.dom.Event): Self = StObject.set(x, "SVGUnload", value.asInstanceOf[js.Any])
