...
trait IDBIndex extends StObject {
  ...
  def count(key: org.scalajs.dom.IDBKeyRange): org.scalajs.dom.IDBRequest[Any, Double] = js.native
  def count(key: IDBValidKey): org.scalajs.dom.IDBRequest[Any, Double] = js.native
  
  def get(key: org.scalajs.dom.IDBKeyRange): org.scalajs.dom.IDBRequest[Any, js.UndefOr[Any]] = js.native
  /**
    ...
    */
  /* standard dom */
  def get(key: IDBValidKey): org.scalajs.dom.IDBRequest[Any, js.UndefOr[Any]] = js.native
  ...
  def getKey(key: org.scalajs.dom.IDBKeyRange): org.scalajs.dom.IDBRequest[Any, js.UndefOr[IDBValidKey]] = js.native
  /**
    ...
    */
  /* standard dom */
  def getKey(key: IDBValidKey): org.scalajs.dom.IDBRequest[Any, js.UndefOr[IDBValidKey]] = js.native
