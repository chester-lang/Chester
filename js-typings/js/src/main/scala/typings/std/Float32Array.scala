...
/* index */ NumberDictionary[Double] {
  ...
  /**
    ...
    */
  /* standard es5 */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): js.typedarray.Float32Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any],
    thisArg: Any
  ...
  /**
    ...
    */
  /* standard es5 */
  def map(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Double]): js.typedarray.Float32Array = js.native
  def map(
  ...
  /**
    ...
    */
  /* standard es5 */
  def reverse(): js.typedarray.Float32Array = js.native
  ...
  /**
    ...
    */
  /* standard es5 */
  def slice(): js.typedarray.Float32Array = js.native
  def slice(start: Double): js.typedarray.Float32Array = js.native
  def slice(start: Double, end: Double): js.typedarray.Float32Array = js.native
  def slice(start: Unit, end: Double): js.typedarray.Float32Array = js.native
  ...
  /**
    ...
    */
  /* standard es5 */
  def subarray(): js.typedarray.Float32Array = js.native
  def subarray(begin: Double): js.typedarray.Float32Array = js.native
  def subarray(begin: Double, end: Double): js.typedarray.Float32Array = js.native
  def subarray(begin: Unit, end: Double): js.typedarray.Float32Array = js.native
