...
/* index */ NumberDictionary[Double] {
  ...
  /**
    ...
    */
  /* standard es5 */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): js.typedarray.Uint8ClampedArray = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any],
    thisArg: Any
  ...
  /**
    ...
    */
  /* standard es5 */
  def map(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Double]): js.typedarray.Uint8ClampedArray = js.native
  def map(
  ...
  /**
    ...
    */
  /* standard es5 */
  def reverse(): js.typedarray.Uint8ClampedArray = js.native
  ...
  /**
    ...
    */
  /* standard es5 */
  def slice(): js.typedarray.Uint8ClampedArray = js.native
  def slice(start: Double): js.typedarray.Uint8ClampedArray = js.native
  def slice(start: Double, end: Double): js.typedarray.Uint8ClampedArray = js.native
  def slice(start: Unit, end: Double): js.typedarray.Uint8ClampedArray = js.native
  ...
  /**
    ...
    */
  /* standard es5 */
  def subarray(): js.typedarray.Uint8ClampedArray = js.native
  def subarray(begin: Double): js.typedarray.Uint8ClampedArray = js.native
  def subarray(begin: Double, end: Double): js.typedarray.Uint8ClampedArray = js.native
  def subarray(begin: Unit, end: Double): js.typedarray.Uint8ClampedArray = js.native
