...
trait RTCIceTransport
  ...
  /* standard dom */
  def getLocalCandidates(): js.Array[org.scalajs.dom.RTCIceCandidate] = js.native
  
  /* standard dom */
  def getLocalParameters(): RTCIceParameters | Null = js.native
  
  /* standard dom */
  def getRemoteCandidates(): js.Array[org.scalajs.dom.RTCIceCandidate] = js.native
  ...
  /* standard dom */
  var onselectedcandidatepairchange: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.Event, Any]) | Null = js.native
