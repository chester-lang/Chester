...
trait NavigatorBeacon extends StObject {
  ...
  def sendBeacon(url: java.lang.String, data: org.scalajs.dom.Blob): scala.Boolean = js.native
  def sendBeacon(url: java.lang.String, data: org.scalajs.dom.FormData): scala.Boolean = js.native
}
