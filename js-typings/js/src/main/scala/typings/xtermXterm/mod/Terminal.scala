...
import typings.xtermXterm.anon.Cols
import typings.xtermXterm.anon.DomEvent
import typings.xtermXterm.anon.End
...
open class Terminal ()
  ...
  /**
    ...
    * ```
    */
  def attachCustomWheelEventHandler(customWheelEventHandler: js.Function1[/* event */ WheelEvent, Boolean]): Unit = js.native
  ...
  /**
    ...
    * application.
    */
  def input(data: String): Unit = js.native
  def input(data: String, wasUserInput: Boolean): Unit = js.native
...
object Terminal {
  ...
  /**
    ...
    */
  @JSImport("@xterm/xterm", "Terminal.strings")
  @js.native
